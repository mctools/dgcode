...
#include <dgboost/mpl/lambda.hpp> // #including this first is an intel6 workaround
#include <dgboost/cstdint.hpp>

#include <dgboost/python/object/class.hpp>
#include <dgboost/python/object/instance.hpp>
#include <dgboost/python/object/class_detail.hpp>
#include <dgboost/python/scope.hpp>
#include <dgboost/python/converter/registry.hpp>
#include <dgboost/python/object/find_instance.hpp>
#include <dgboost/python/object/pickle_support.hpp>
#include <dgboost/python/detail/map_entry.hpp>
#include <dgboost/python/object.hpp>
#include <dgboost/python/object_protocol.hpp>
#include <dgboost/detail/binary_search.hpp>
#include <dgboost/python/self.hpp>
...
void* instance_holder::allocate(PyObject* self_, std::size_t holder_offset, std::size_t holder_size, std::size_t alignment)
{
    ...
    if (-Py_SIZE(self) >= total_size_needed)
    {
        ...
        void* aligned_storage = ::dgboost::alignment::align(alignment, holder_size, storage, allocated);
