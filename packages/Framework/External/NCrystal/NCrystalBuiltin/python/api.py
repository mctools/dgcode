...
import NCrystalBuiltin as NCrystal.api as NC

Which will for now do the same as "import NCrystalBuiltin as NC". However, it might be
that we will eventually modify the default behaviour to not include anything
when merely doing "import NCrystalBuiltin as NCrystal", so the "import NCrystalBuiltin as NCrystal.api as NC" will be
