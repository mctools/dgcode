...
def _find_nclib():
    ...
    ncrystal_namespace_protection = None
    if _nclibpath and hasattr(_nclibpath,'ncrystal_namespace_protection'):
        ncrystal_namespace_protection = _nclibpath.ncrystal_namespace_protection
    ...
    if not libloc:
        ...
        #FIXME: Automatically extract ncrystal_namespace_protection in this case as well?
