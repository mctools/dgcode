    ...
    class DI_ScatKnl(DynamicInfo):
        ...
        def _loadKernel( self, vdoslux = 3 ):
            ...
            if self.__lastvdoslux != vdoslux:
                ...
                sugEmax,ne,na,nb,eptr,aptr,bptr,sabptr = _rawfct['ncrystalrel_dyninfo_extract_scatknl'](key,vdoslux)
    ...
    class DI_VDOS(DI_ScatKnl):
        ...
        def vdosData(self):
            ...
            if self.__vdosdata is None:
                _keepalive, key = self._key
                emin,emax,nd,dptr = _rawfct['ncrystalrel_dyninfo_extract_vdos'](key)
        ...
        def __loadVDOSOrig(self):
            if self.__vdosorig is None:
                _keepalive, key = self._key
                neg,egptr,nds,dsptr = _rawfct['ncrystalrel_dyninfo_extract_vdos_input'](key)
    ...
    class DI_VDOSDebye(DI_ScatKnl):
        ...
        def debyeTemperature(self):
            ...
            if self.__debyetemp is None:
                _keepalive, key = self._key
                self.__debyetemp = _rawfct['ncrystalrel_dyninfo_extract_vdosdebye'](key)
    ...
    def getDynamicInfoList(self):
        ...
        if self.__dyninfo is None:
            ...
            for idx in range(int(_rawfct['ncrystalrel_info_ndyninfo'](self._rawobj))):
                fr,tt,atomidx,ditype = _rawfct['ncrystalrel_dyninfo_base']((self._rawobj,idx))
