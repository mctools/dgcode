...
def debyeIsotropicMSD( *, debye_temperature, temperature, mass ):
    ...
    return float(_get_raw_cfcts()['ncrystalrel_debyetemp2msd'](debye_temperature, temperature, mass))
...
def debyeTempFromIsotropicMSD( *, msd, temperature, mass ):
    ...
    """
    from ._chooks import _get_raw_cfcts
    return float(_get_raw_cfcts()['ncrystalrel_msd2debyetemp'](msd, temperature, mass))
...
def _do_regularise( egrid, density, n, quiet = False):
    #Regularisation function adapted from ncrystalrel_vdos2ncmat
