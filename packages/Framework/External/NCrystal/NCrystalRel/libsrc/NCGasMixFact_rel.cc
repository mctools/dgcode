...
#include "NCrystalRel/internal_NCGasMixUtils.hh"
...
extern "C" void ncrystalrel_register_quickgasmix_factory()
{
  //Called from ncrystalrel_register_quick_factory(), to be part of the same "stdquick" plugin.
