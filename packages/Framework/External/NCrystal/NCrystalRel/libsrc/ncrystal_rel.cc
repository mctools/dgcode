...
void ncrystalrel_raw_vdos2gn( const double* vdos_egrid,
                           const double* vdos_density,
                           unsigned vdos_egrid_npts,
                           unsigned vdos_density_npts,
...
void ncrystalrel_raw_vdos2knl( const double* vdos_egrid,
                            const double* vdos_density,
                            unsigned vdos_egrid_npts,
                            unsigned vdos_density_npts,
                            double scattering_xs,
...
void ncrystalrel_dealloc_doubleptr( double* arr )
{
  delete[] arr;
}
                                              ...
                                              unsigned atomdataindex )
{
  try {
    ...
    if ( aidx.isInvalid() )
      NCRYSTAL_THROW2(BadInput,"ncrystalrel_create_atomdata: provided atomdataidx is invalid.");
...
ncrystalrel_atomdata_t ncrystalrel_create_component_atomdata( ncrystalrel_info_t nfo,
                                                        unsigned icomponent )
{
  try {
    auto& info = ncc::extract(nfo);
...
char * ncrystalrel_ncmat2json( const char * input )
{
  try {
...
char * ncrystalrel_get_flatcompos( ncrystalrel_info_t nfo,
                                int prefernatelem,
