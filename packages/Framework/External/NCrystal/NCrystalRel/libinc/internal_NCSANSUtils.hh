#ifndef NCrystalRel_SANSUtils_hh
#define NCrystalRel_SANSUtils_hh
...
inline NCrystalRel::SANSScaleFactor::SANSScaleFactor( SLDContrast drho, NumberDensity nd, double phi )
