...
inline void * NCrystalRel::AlignedAlloc::alignedAlloc( std::size_t alignment, std::size_t size )
{
  nc_assert( size>0 );
...
template<std::size_t NALIGN>
void * NCrystalRel::AlignedAlloc::alignedAllocFixedAlign( std::size_t size )
{
  static_assert( detail::is_pow2<NALIGN>(), "" );
  nc_assert( size>0 );
...
template<std::size_t NALIGN, std::size_t NSIZE>
inline void * NCrystalRel::AlignedAlloc::alignedAllocT()
{
  static_assert( detail::is_pow2<NALIGN>(), "" );
...
inline void NCrystalRel::AlignedAlloc::freeAlignedAlloc( std::size_t alignment, void* addr )
{
  assert( addr );
...
template<std::size_t NALIGN>
inline void NCrystalRel::AlignedAlloc::freeAlignedAllocFixedAlign( void * addr )
{
  assert( addr );
  static_assert( detail::is_pow2<NALIGN>(), "" );
...
template< std::size_t NALIGN>
inline NCrystalRel::AlignedAlloc::AlignedHeapPtr<NALIGN>& NCrystalRel::AlignedAlloc::AlignedHeapPtr<NALIGN>::operator=( AlignedHeapPtr<NALIGN>&& o )
{
  deallocate();
...
template< std::size_t NALIGN>
inline void NCrystalRel::AlignedAlloc::AlignedHeapPtr<NALIGN>::allocate( std::size_t nbytes )
{
  deallocate();
...
template< std::size_t NALIGN>
inline void NCrystalRel::AlignedAlloc::AlignedHeapPtr<NALIGN>::deallocate()
{
  if ( !data )
    return;
  void * ddata = data;
