#ifndef NCrystalRel_SABUCN_hh
#define NCrystalRel_SABUCN_hh
...
inline NCrystalRel::CrossSect NCrystalRel::UCN::UCNHelper::crossSection( NeutronEnergy ekin ) const
{
  if ( isNull() )
...
inline bool NCrystalRel::UCN::UCNHelper::isNull() const
{
