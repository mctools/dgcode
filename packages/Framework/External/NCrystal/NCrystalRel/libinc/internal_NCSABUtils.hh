...
inline std::size_t NCrystalRel::SABUtils::calcSABIdx( std::size_t nalpha, std::size_t alpha_idx, std::size_t beta_idx)
{
...
inline double NCrystalRel::SABUtils::interpolate_linear(double a, double fa, double b, double fb, double x)
{
  nc_assert( b > a );
...
template<NCrystalRel::SABUtils::InterpolationScheme scheme>
inline double NCrystalRel::SABUtils::interpolate(double a, double fa, double b, double fb, double x) {
