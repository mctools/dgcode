...
inline double NCrystalRel::ncclamp(double val, PairDD low_and_up) { return ncclamp(val,low_and_up.first,low_and_up.second); }
...
inline bool NCrystalRel::ncisnanorinf(double a) { return std::isnan(a) || std::isinf(a); }
...
inline bool NCrystalRel::intervalsOverlap( const PairDD& x, const PairDD& y )
{
...
template <class Func>
inline double NCrystalRel::integrateRombergFlex(const Func& f, double a, double b, double prec, unsigned minlvl, unsigned maxlvl )
{
