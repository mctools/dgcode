...
#include <dgboost/container/detail/config_begin.hpp>
#include <dgboost/container/detail/workaround.hpp>

// container
#include <dgboost/container/container_fwd.hpp>
#include <dgboost/container/detail/mpl.hpp>
#include <dgboost/container/detail/type_traits.hpp>  //is_empty
#include <dgboost/container/detail/placement_new.hpp>
#ifndef BOOST_CONTAINER_DETAIL_STD_FWD_HPP
#include <dgboost/container/detail/std_fwd.hpp>
#endif
// intrusive
#include <dgboost/intrusive/pointer_traits.hpp>
#include <dgboost/intrusive/detail/mpl.hpp>
// move
#include <dgboost/move/utility_core.hpp>
// move/detail
#if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
#include <dgboost/move/detail/fwd_macros.hpp>
#endif
// other boost
...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace container { namespace dtl {
...
#include <dgboost/intrusive/detail/has_member_function_callable_with.hpp>
...
struct allocator_traits
{
   ...
   typedef typename allocator_type::value_type value_type;
   ...
   #else
      //pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(dgboost::container::dtl::, Allocator,
         pointer, value_type*)
            pointer;
      //const_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(dgboost::container::dtl::, Allocator,
         const_pointer, typename dgboost::intrusive::pointer_traits<pointer>::template
      ...
      //void_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(dgboost::container::dtl::, Allocator,
         void_pointer, typename dgboost::intrusive::pointer_traits<pointer>::template
            rebind_pointer<void>)
               void_pointer;
      //const_void_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(dgboost::container::dtl::, Allocator,
         const_void_pointer, typename dgboost::intrusive::pointer_traits<pointer>::template
      ...
      //rebind_alloc & rebind_traits
         ...
         //C++11
         template <typename T> using rebind_alloc  = typename dgboost::intrusive::pointer_rebind<Allocator, T>::type;
         template <typename T> using rebind_traits = allocator_traits< rebind_alloc<T> >;
      #else    // #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         //Some workaround for C++03 or C++11 compilers with no template aliases
         template <typename T>
         struct rebind_alloc : dgboost::intrusive::pointer_rebind<Allocator,T>::type
         {
            typedef typename dgboost::intrusive::pointer_rebind<Allocator,T>::type Base;
            #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
               template <typename... Args>
               rebind_alloc(BOOST_FWD_REF(Args)... args) : Base(dgboost::forward<Args>(args)...) {}
         ...
         struct rebind_traits
            : allocator_traits<typename dgboost::intrusive::pointer_rebind<Allocator, T>::type>
         {};
      ...
      template <class T>
      struct portable_rebind_alloc
      {  typedef typename dgboost::intrusive::pointer_rebind<Allocator, T>::type type;  };
   ...
   {
      const bool value = dgboost::container::dtl::
   ...
   select_on_container_copy_construction(const Allocator &a)
   {
      ...
      {
         static const bool value = ::dgboost::move_detail::and_
            < dtl::is_not_std_allocator<Allocator>
            , dgboost::container::dtl::has_member_function_callable_with_construct
                  < Allocator, T*, Args... >
            >::value;
         dtl::bool_<value> flag;
         allocator_traits::priv_construct(flag, a, p, ::dgboost::forward<Args>(args)...);
      }
   #endif
   ...
   template<class T>
   BOOST_CONTAINER_FORCEINLINE static void priv_construct(dtl::false_type, Allocator &, T *p, const ::dgboost::container::default_init_t&)
...
#include <dgboost/container/detail/config_end.hpp>
