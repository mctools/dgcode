...
#include <dgboost/container_hash/detail/float_functions.hpp>
#include <dgboost/container_hash/detail/limits.hpp>
#include <dgboost/core/enable_if.hpp>
#include <dgboost/integer/static_log2.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME dgboost::enable_if_c<
        ...
        {
            dgboost::hash_detail::call_frexp<T> frexp;
            dgboost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        dgboost::static_log2<limits<T>::radix>::value
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return dgboost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
