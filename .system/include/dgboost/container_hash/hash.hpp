...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
    ...
    namespace hash_detail
    {
        ...
        inline void hash_combine_impl(dgboost::uint32_t& h1,
                dgboost::uint32_t k1)
        {
...
// and also not for 32-bit gcc as it warns about the 64-bit constant.
        ...
        inline void hash_combine_impl(dgboost::uint64_t& h,
                dgboost::uint64_t k)
        {
            const dgboost::uint64_t m = UINT64_C(0xc6a4a7935bd1e995);
            const int r = 47;
...
#pragma warning(disable:4267) // 'argument' : conversion from 'size_t' to
    ...
    inline void hash_combine(std::size_t& seed, T const& v)
    {
        ...
        return dgboost::hash_detail::hash_combine_impl(seed, hasher(v));
    }
