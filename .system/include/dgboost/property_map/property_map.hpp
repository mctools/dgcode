...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  ...
  struct property_traits :
    dgboost::mpl::if_<is_property_map<PA>,
  ...
  struct property_traits<T*> {
    // BOOST_STATIC_ASSERT(dgboost::is_same<T, T*>::value && !"Using pointers as property maps is deprecated");
  ...
  // do dgboost::get() anyways, and the using clause
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef dgboost::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef dgboost::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef dgboost::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef dgboost::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      BOOST_MPL_ASSERT((dgboost::mpl::or_<
                          dgboost::is_same<const value_type&, reference>,
                          dgboost::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    void constraints() {
      ...
      typedef typename property_traits<PMap>::value_type value_type;
      BOOST_MPL_ASSERT((dgboost::is_same<value_type&, reference>));
  ...
  class iterator_property_map
    : public dgboost::put_get_helper< R, 
  ...
  class static_property_map :
      public
  dgboost::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      dgboost::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
    typedef KeyType key_type;
  ...
  template <typename T>
  struct typed_identity_property_map
    : public dgboost::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public dgboost::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    ...
    typedef dgboost::read_write_property_map_tag category;
