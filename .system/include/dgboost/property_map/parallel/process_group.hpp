...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace graph { namespace distributed {
  using dgboost::parallel::trigger_receive_context;
  using dgboost::parallel::trc_early_receive;
  using dgboost::parallel::trc_out_of_band;
  using dgboost::parallel::trc_irecv_out_of_band;
  using dgboost::parallel::trc_in_synchronization;
  using dgboost::parallel::trc_none;
  using dgboost::parallel::attach_distributed_object;
} } } // end namespace dgboost::graph::distributed
