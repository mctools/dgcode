...
#include <dgboost/weak_ptr.hpp>
#include <dgboost/optional.hpp>
#include <dgboost/property_map/parallel/process_group.hpp>
#include <dgboost/function/function1.hpp>
#include <vector>
#include <set>
#include <dgboost/property_map/parallel/basic_reduce.hpp>
#include <dgboost/property_map/parallel/detail/untracked_pair.hpp>
#include <dgboost/type_traits/is_same.hpp>
#include <dgboost/property_map/parallel/local_property_map.hpp>
#include <map>
#include <dgboost/version.hpp>
#include <dgboost/property_map/parallel/unsafe_serialize.hpp>
#include <dgboost/multi_index_container.hpp>
#include <dgboost/multi_index/hashed_index.hpp>
#include <dgboost/multi_index/member.hpp>
#include <dgboost/multi_index/sequenced_index.hpp>

// Serialization functions for constructs we use
#include <dgboost/serialization/utility.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parallel {
 ...
 public:
  ...
  request_put(process_id_type p, const key_type& k, const value_type& v) const
  {
    send(data->process_group, p, property_map_put,
         dgboost::parallel::detail::make_untracked_pair(k, v));
  }
 ...
 private:
  ...
  struct handle_message
  {
    ...
    handle_put(int source, int tag,
               const dgboost::parallel::detail::untracked_pair<key_type, value_type>& data,
    ...
    handle_multiget_reply
      (int source, int tag,
       const std::vector<dgboost::parallel::detail::untracked_pair<key_type, value_type> >& msg,
       trigger_receive_context);
...
} } // end namespace dgboost::parallel

#include <dgboost/property_map/parallel/impl/distributed_property_map.ipp>
