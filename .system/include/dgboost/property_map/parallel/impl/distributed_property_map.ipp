...
#include <dgboost/property_map/parallel/distributed_property_map.hpp>
...
#include <dgboost/property_map/parallel/simple_trigger.hpp>
...
void PBGL_DISTRIB_PMAP::prune_ghost_cells() const
{
  ...
  while (data->ghost_cells->size() > data->max_ghost_cells) {
    ...
    if (data->model & cm_flush) {
      ...
      dgboost::parallel::detail::untracked_pair<key_type, value_type> const& victim
...
handle_put(int /*source*/, int /*tag*/, 
           const dgboost::parallel::detail::untracked_pair<key_type, value_type>& req, trigger_receive_context)
{
  using dgboost::get;
                ...
                trigger_receive_context)
{
  ...
  typedef dgboost::parallel::detail::untracked_pair<key_type, value_type> key_value;
...
{
  using dgboost::parallel::simple_trigger;
...
PBGL_DISTRIB_PMAP::set_max_ghost_cells(std::size_t max_ghost_cells)
{
  if ((data->model & cm_backward) && max_ghost_cells > 0)
      dgboost::throw_exception(std::runtime_error("distributed_property_map::set_max_ghost_cells: "
