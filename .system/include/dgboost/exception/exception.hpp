...
#include  <memory>
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace exception_detail { using std::shared_ptr; } }
#else
namespace dgboost {} namespace boost = dgboost; namespace dgboost { template <class T> class shared_ptr; }
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace exception_detail { using dgboost::shared_ptr; } }
#endif
...
namespace dgboost {} namespace boost = dgboost; namespace
dgboost
    {
    namespace
    exception_detail
    ...
    exception_detail
        ...
        dgboost::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing dgboost::exception.
        ...
        friend dgboost::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline dgboost::source_location get_exception_throw_location( exception const & x )
            {
