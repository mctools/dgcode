...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return dgboost::detail::addrof<T>::get(o, 0);
#else
    return dgboost::detail::addrof<T>::get(dgboost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename dgboost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return dgboost::detail::addressof(o);
}
#endif
