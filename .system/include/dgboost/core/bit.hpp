...
BOOST_CONSTEXPR inline int countl_impl( dgboost::ulong_long_type x ) BOOST_NOEXCEPT
{
    return x? __builtin_clzll( x ): std::numeric_limits<dgboost::ulong_long_type>::digits;
}
...
{
    return dgboost::core::detail::countl_impl( x );
}
...
inline int countl_impl( dgboost::uint32_t x ) BOOST_NOEXCEPT
{
#if defined(_MSC_VER)
...
inline int countl_impl( dgboost::uint64_t x ) BOOST_NOEXCEPT
{
    ...
    return static_cast<dgboost::uint32_t>( x >> 32 ) != 0?
        dgboost::core::detail::countl_impl( static_cast<dgboost::uint32_t>( x >> 32 ) ):
        dgboost::core::detail::countl_impl( static_cast<dgboost::uint32_t>( x ) ) + 32;

#endif
}

inline int countl_impl( dgboost::uint8_t x ) BOOST_NOEXCEPT
{
    return dgboost::core::detail::countl_impl( static_cast<dgboost::uint32_t>( x ) ) - 24;
}

inline int countl_impl( dgboost::uint16_t x ) BOOST_NOEXCEPT
{
    return dgboost::core::detail::countl_impl( static_cast<dgboost::uint32_t>( x ) ) - 16;
}
...
{
    BOOST_STATIC_ASSERT( sizeof(T) == sizeof(dgboost::uint8_t) || sizeof(T) == sizeof(dgboost::uint16_t) || sizeof(T) == sizeof(dgboost::uint32_t) || sizeof(T) == sizeof(dgboost::uint64_t) );

    BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(dgboost::uint8_t) )
    {
        return dgboost::core::detail::countl_impl( static_cast<dgboost::uint8_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(dgboost::uint16_t) )
    {
        return dgboost::core::detail::countl_impl( static_cast<dgboost::uint16_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(dgboost::uint32_t) )
    {
        return dgboost::core::detail::countl_impl( static_cast<dgboost::uint32_t>( x ) );
    }
    else
    {
        return dgboost::core::detail::countl_impl( static_cast<dgboost::uint64_t>( x ) );
    }
}
...
{
    return dgboost::core::countl_zero( static_cast<T>( ~x ) );
}
...
BOOST_CONSTEXPR inline int countr_impl( dgboost::ulong_long_type x ) BOOST_NOEXCEPT
{
    return x? __builtin_ctzll( x ): std::numeric_limits<dgboost::ulong_long_type>::digits;
}
...
{
    return dgboost::core::detail::countr_impl( x );
}
...
inline int countr_impl( dgboost::uint32_t x ) BOOST_NOEXCEPT
{
#if defined(_MSC_VER)
    ...
    return mod37[ ( -(dgboost::int32_t)x & x ) % 37 ];

#endif
}

inline int countr_impl( dgboost::uint64_t x ) BOOST_NOEXCEPT
{
#if defined(_MSC_VER) && defined(_M_X64)
    ...
    return static_cast<dgboost::uint32_t>( x ) != 0?
        dgboost::core::detail::countr_impl( static_cast<dgboost::uint32_t>( x ) ):
        dgboost::core::detail::countr_impl( static_cast<dgboost::uint32_t>( x >> 32 ) ) + 32;

#endif
}

inline int countr_impl( dgboost::uint8_t x ) BOOST_NOEXCEPT
{
    return dgboost::core::detail::countr_impl( static_cast<dgboost::uint32_t>( x ) | 0x100 );
}

inline int countr_impl( dgboost::uint16_t x ) BOOST_NOEXCEPT
{
    return dgboost::core::detail::countr_impl( static_cast<dgboost::uint32_t>( x ) | 0x10000 );
}
...
int countr_zero( T x ) BOOST_NOEXCEPT
{
    ...
    BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(dgboost::uint8_t) )
    {
        return dgboost::core::detail::countr_impl( static_cast<dgboost::uint8_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(dgboost::uint16_t) )
    {
        return dgboost::core::detail::countr_impl( static_cast<dgboost::uint16_t>( x ) );
    }
    else BOOST_IF_CONSTEXPR ( sizeof(T) == sizeof(dgboost::uint32_t) )
    {
        return dgboost::core::detail::countr_impl( static_cast<dgboost::uint32_t>( x ) );
    }
    else
    {
        return dgboost::core::detail::countr_impl( static_cast<dgboost::uint64_t>( x ) );
    }
}
...
{
    return dgboost::core::countr_zero( static_cast<T>( ~x ) );
}
...
BOOST_CORE_POPCOUNT_CONSTEXPR inline int popcount_impl( dgboost::ulong_long_type x ) BOOST_NOEXCEPT
{
...
{
    return dgboost::core::detail::popcount_impl( x );
}
...
BOOST_CXX14_CONSTEXPR inline int popcount_impl( dgboost::uint32_t x ) BOOST_NOEXCEPT
{
    x = x - ( ( x >> 1 ) & 0x55555555 );
...
BOOST_CXX14_CONSTEXPR inline int popcount_impl( dgboost::uint64_t x ) BOOST_NOEXCEPT
{
...
{
    BOOST_STATIC_ASSERT( sizeof(T) <= sizeof(dgboost::uint64_t) );

    BOOST_IF_CONSTEXPR ( sizeof(T) <= sizeof(dgboost::uint32_t) )
    {
        return dgboost::core::detail::popcount_impl( static_cast<dgboost::uint32_t>( x ) );
    }
    else
    {
        return dgboost::core::detail::popcount_impl( static_cast<dgboost::uint64_t>( x ) );
    }
}
...
BOOST_CONSTEXPR T bit_width( T x ) BOOST_NOEXCEPT
{
    return static_cast<T>(
        std::numeric_limits<T>::digits - dgboost::core::countl_zero( x ) );
}

template<class T>
BOOST_CONSTEXPR T bit_floor( T x ) BOOST_NOEXCEPT
{
    return x == 0? 0: T(1) << ( dgboost::core::bit_width( x ) - 1 );
}

namespace detail
{

BOOST_CXX14_CONSTEXPR inline dgboost::uint32_t bit_ceil_impl( dgboost::uint32_t x ) BOOST_NOEXCEPT
{
    if( x == 0 )
    {
        return 0;
...
BOOST_CXX14_CONSTEXPR inline dgboost::uint64_t bit_ceil_impl( dgboost::uint64_t x ) BOOST_NOEXCEPT
{
    if( x == 0 )
    {
        return 0;
...
BOOST_CXX14_CONSTEXPR T bit_ceil( T x ) BOOST_NOEXCEPT
{
    ...
    BOOST_IF_CONSTEXPR ( sizeof(T) <= sizeof(dgboost::uint32_t) )
    {
        return static_cast<T>( dgboost::core::detail::bit_ceil_impl( static_cast<dgboost::uint32_t>( x ) ) );
    }
    else
    {
        return static_cast<T>( dgboost::core::detail::bit_ceil_impl( static_cast<dgboost::uint64_t>( x ) ) );
    }
}
