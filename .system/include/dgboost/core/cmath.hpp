...
{
    return dgboost::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return dgboost::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return dgboost::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return dgboost::core::detail::copysign_impl( x, y );
}
