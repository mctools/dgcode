...
struct remove_cv_ref
{
    typedef typename ::dgboost::remove_cv<typename
     ::dgboost::remove_reference<T>::type>::type  type;

};  // dgboost::detail::remove_cv_ref
...
struct is_related
    : public ::dgboost::is_same<
     typename ::dgboost::detail::remove_cv_ref<T>::type,
     typename ::dgboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::dgboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::dgboost::disable_if< ::dgboost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::dgboost::detail::enable_if_unrelated<base_from_member, T...>::type>
