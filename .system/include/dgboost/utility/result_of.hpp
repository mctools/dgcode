...
template<class T> struct result_of_has_result_type_impl
{
    ...
    typedef dgboost::integral_constant<bool, sizeof(f<T>(0)) == sizeof(result_of_yes_type)> type;
};
...
#  include <dgboost/utility/detail/result_of_variadic.hpp>
#else
#  define BOOST_PP_ITERATION_PARAMS_1 (3,(0,BOOST_RESULT_OF_NUM_ARGS,<dgboost/utility/detail/result_of_iterate.hpp>))
#  include BOOST_PP_ITERATE()
#endif

#if 0
// inform dependency trackers, as they can't see through macro includes
#include <dgboost/utility/detail/result_of_iterate.hpp>
#endif
