...
#include <dgboost/core/nvp.hpp>
#include <dgboost/preprocessor/stringize.hpp>

#define BOOST_SERIALIZATION_NVP(name)                       \
    dgboost::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)           \
    dgboost::serialization::make_nvp(                         \
        BOOST_PP_STRINGIZE(name),                           \
        dgboost::serialization::base_object<name >(*this)     \
    )
/**/

#include <dgboost/serialization/level.hpp>
#include <dgboost/serialization/tracking.hpp>
#include <dgboost/serialization/split_free.hpp>
#include <dgboost/serialization/wrapper.hpp>
#include <dgboost/serialization/base_object.hpp>
...
struct is_wrapper<const nvp<T> > {
    typedef dgboost::mpl::true_ type;
};
template<class T>
