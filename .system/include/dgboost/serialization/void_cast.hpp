    ...
    private dgboost::noncopyable
{
    ...
    friend 
    BOOST_SERIALIZATION_DECL void const *
    dgboost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            dgboost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            dgboost::serialization::smart_cast<const Base *, const Derived *>(
...
{
    typedef
        typename mpl::eval_if<dgboost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
