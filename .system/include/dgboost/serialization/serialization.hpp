...
#include <dgboost/serialization/strong_typedef.hpp>
...
// by specifying friend class dgboost::serialization::access
...
// i.e. dgboost::serialization will be searched.
// 
