...
struct static_warning_test{
    typename dgboost::mpl::eval_if_c<
        B,
        dgboost::mpl::true_,
        typename dgboost::mpl::identity<
            dgboost::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef dgboost::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( dgboost::serialization::static_warning_test< B, L > ) \
