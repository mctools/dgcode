...
#include <dgboost/serialization/array_optimization.hpp>
...
private:
    ...
    friend const dgboost::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & dgboost::serialization::make_nvp("item", *t++);
    }
    ...
    {
      dgboost::serialization::split_member(ar, *this, version);
    }
    ...
    {
      typedef typename 
          dgboost::serialization::use_array_optimization<Archive>::template apply<
