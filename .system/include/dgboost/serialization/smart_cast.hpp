...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                dgboost::is_same<void *, U>,
                dgboost::is_same<void *, T>,
                dgboost::is_same<const void *, U>,
                dgboost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<dgboost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<dgboost::is_reference<U>,
