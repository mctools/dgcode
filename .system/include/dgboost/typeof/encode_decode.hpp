...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace dgboost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER dgboost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER dgboost::type_of
