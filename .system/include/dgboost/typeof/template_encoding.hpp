...
#include <dgboost/preprocessor/repetition/enum_trailing.hpp>
#include <dgboost/preprocessor/control/iif.hpp>
#include <dgboost/preprocessor/detail/is_unary.hpp>
#include <dgboost/preprocessor/repetition/repeat.hpp>
#include <dgboost/preprocessor/tuple/eat.hpp>
#include <dgboost/preprocessor/seq/transform.hpp>
#include <dgboost/preprocessor/seq/for_each_i.hpp>
#include <dgboost/preprocessor/seq/cat.hpp>

#include <dgboost/typeof/encode_decode.hpp>
#include <dgboost/typeof/int_encoding.hpp>

#include <dgboost/typeof/type_template_param.hpp>
#include <dgboost/typeof/integral_template_param.hpp>
#include <dgboost/typeof/template_template_param.hpp>
...
#define BOOST_TYPEOF_REGISTER_TEMPLATE_IMPL(Name, Params, Size, ID)\
    ...
    {\
        typedef typename dgboost::type_of::push_back<V, dgboost::type_of::constant<std::size_t,ID> >::type V0;\
        BOOST_PP_SEQ_FOR_EACH_I(BOOST_TYPEOF_REGISTER_TEMPLATE_ENCODE_PARAM, ~, Params)\
        typedef BOOST_PP_CAT(V, Size) type;\
    };\
    template<class Iter>\
    struct decode_type_impl<dgboost::type_of::constant<std::size_t,ID>, Iter>\
    {\
        typedef decode_type_impl<dgboost::type_of::constant<std::size_t,ID>, Iter> self_t;\
        typedef dgboost::type_of::constant<std::size_t,ID> self_id;\
        typedef Iter iter0;\
