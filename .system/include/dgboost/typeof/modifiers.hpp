...
#define BOOST_TYPEOF_modifier_support(ID, Fun)\
    ...
    {\
        typedef\
            typename dgboost::type_of::encode_type<\
            typename dgboost::type_of::push_back<\
            V\
            , dgboost::type_of::constant<std::size_t,ID> >::type\
            , T>::type\
            type;\
    };\
    template<class Iter> struct decode_type_impl<dgboost::type_of::constant<std::size_t,ID>, Iter>\
    {\
        typedef dgboost::type_of::decode_type<Iter> d1;\
...
#define BOOST_TYPEOF_array_support(ID, Qualifier)\
    ...
    {\
        typedef\
            ...
            V\
            , dgboost::type_of::constant<std::size_t,ID> >::type\
            , dgboost::type_of::constant<std::size_t,N> >::type\
            , T>::type\
        type;\
    };\
    template<class Iter>\
    ...
    {\
        ...
        typedef dgboost::type_of::decode_type<typename Iter::next> d;\
