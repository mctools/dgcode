...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*dgboost::type_of::encode_index((dgboost::type_of::encode_counter<1005>*)0)))
...
# define BOOST_TYPEOF(expr) \
    dgboost::type_of::msvc_typeid_wrapper<sizeof(*dgboost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        enum {_typeof_register_value=sizeof(dgboost::type_of::typeof_register_type<name>(expr))};\
        typedef typename dgboost::type_of::msvc_extract_type<name>::id2type id2type;\
        typedef typename id2type::type type;\
    };
...
# define BOOST_TYPEOF_NESTED_TYPEDEF(name,expr) \
    struct name {\
        enum {_typeof_register_value=sizeof(dgboost::type_of::typeof_register_type<name>(expr))};\
        typedef dgboost::type_of::msvc_extract_type<name>::id2type id2type;\
