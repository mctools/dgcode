...
#include <dgboost/range/concepts.hpp>
#include <iterator>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
    ...
    namespace range
    {
        ...
        inline bool equal( const SinglePassRange1& rng1, const SinglePassRange2& rng2 )
        {
            ...
            return ::dgboost::range_detail::equal(
                ::dgboost::begin(rng1), ::dgboost::end(rng1),
                ::dgboost::begin(rng2), ::dgboost::end(rng2) );
        }
