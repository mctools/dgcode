...
#include <dgboost/iterator/iterator_concepts.hpp>
#include <dgboost/range/begin.hpp>
#include <dgboost/range/end.hpp>
#include <dgboost/range/iterator.hpp>
#include <dgboost/range/value_type.hpp>
#include <dgboost/range/detail/misc_concept.hpp>
...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the dgboost::adaptors::filtered
        // class with a dgboost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                dgboost::ignore_unused_variable_warning(i2);
                ...
                dgboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                dgboost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = dgboost::begin(*m_range);
            iterator i2 = dgboost::end(*m_range);

            dgboost::ignore_unused_variable_warning(i1);
            dgboost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = dgboost::begin(const_range);
            const_iterator ci2 = dgboost::end(const_range);

            dgboost::ignore_unused_variable_warning(ci1);
            dgboost::ignore_unused_variable_warning(ci2);
        }
