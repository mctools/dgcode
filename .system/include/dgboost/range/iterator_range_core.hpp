...
#include <dgboost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <dgboost/iterator/iterator_facade.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( dgboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( dgboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( dgboost::begin(l),
                                                 dgboost::end(l),
                                                 dgboost::begin(r),
                                                 dgboost::end(r) );
        }
...
incrementable_t test_traversal_tag(dgboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(dgboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(dgboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef dgboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef dgboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef dgboost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *dgboost::prior(this->m_End);
    }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                dgboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME dgboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME dgboost::enable_if<
            mpl::not_<dgboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, dgboost::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = dgboost::begin( r ),
                    new_end   = dgboost::end( r );
        ...
        */
        ...
        {
            return SeqT( dgboost::begin( r ), dgboost::end( r ) );
        }
