...
#include <dgboost/range/size_type.hpp>
#include <dgboost/range/detail/has_member_size.hpp>
#include <dgboost/assert.hpp>
#include <dgboost/cstdint.hpp>
#include <dgboost/utility.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
    namespace range_detail
    {
        ...
        inline typename ::dgboost::enable_if<
        ...
        range_calculate_size(const SinglePassRange& rng)
        {
            return std::distance(dgboost::begin(rng), dgboost::end(rng));
        }
    }
...
// but only on the Mac!
        ...
        BOOST_RANGE_CONCEPT_ASSERT((dgboost::SinglePassRangeConcept<SinglePassRange>));
#endif
