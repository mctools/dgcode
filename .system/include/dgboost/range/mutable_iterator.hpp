...
#include <dgboost/range/range_fwd.hpp>
#include <dgboost/range/detail/extract_optional_type.hpp>
...
#include <dgboost/range/detail/msvc_has_iterator_workaround.hpp>
