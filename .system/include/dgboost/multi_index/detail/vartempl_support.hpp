 ...
 *
 * which fill the extra args with dgboost::multi_index::detail::noarg's.
 * dgboost::multi_index::detail::vartempl_placement_new works the opposite
...
#include <dgboost/preprocessor/arithmetic/add.hpp>
#include <dgboost/preprocessor/arithmetic/sub.hpp>
#include <dgboost/preprocessor/cat.hpp>
#include <dgboost/preprocessor/control/if.hpp>
#include <dgboost/preprocessor/facilities/empty.hpp>
#include <dgboost/preprocessor/facilities/intercept.hpp>
#include <dgboost/preprocessor/logical/and.hpp>
#include <dgboost/preprocessor/punctuation/comma.hpp>
#include <dgboost/preprocessor/punctuation/comma_if.hpp>
...
dgboost::forward<BOOST_PP_CAT(T,n)>(BOOST_PP_CAT(t,n))
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost{namespace multi_index{namespace detail{
struct noarg{};
}}}
...
BOOST_PP_ENUM_PARAMS(                                                \
  BOOST_MULTI_INDEX_LIMIT_VARTEMPL_ARGS,                             \
  dgboost::multi_index::detail::noarg() BOOST_PP_INTERCEPT)
