...
struct allocator_traits
{
  ...
  /* [const_]void_pointer not provided as dgboost::pointer_traits's
   * rebind_to has been seen to fail with things like
   * dgboost::interprocess::offset_ptr in relatively old environments.
   */
  ...
  static void      construct(Allocator&,T* p,BOOST_RV_REF(T) x)
                     {::new (static_cast<void*>(p)) T(dgboost::move(x));}
