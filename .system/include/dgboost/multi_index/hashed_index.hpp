...
#include <dgboost/multi_index/detail/bucket_array.hpp>
#include <dgboost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <dgboost/multi_index/detail/hash_index_iterator.hpp>
#include <dgboost/multi_index/detail/index_node_base.hpp>
#include <dgboost/multi_index/detail/invalidate_iterators.hpp>
#include <dgboost/multi_index/detail/modify_key_adaptor.hpp>
#include <dgboost/multi_index/detail/node_handle.hpp>
#include <dgboost/multi_index/detail/promotes_arg.hpp>
...
#include <dgboost/multi_index/hashed_index_fwd.hpp>
...
public:
  ...
  {
    return make_iterator(
      node_from_value<index_node_type>(dgboost::addressof(x)));
  }
  ...
  insert_return_type insert(BOOST_RV_REF(node_type) nh)
  {
    ...
    return insert_return_type(make_iterator(p.first),p.second,dgboost::move(nh));
  }
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  bool equals(const hashed_index& x,hashed_non_unique_tag)const
  {
    ...
    for(const_iterator it=begin(),it_end=end();it!=it_end;){
      ...
      dgboost::tie(it2,it2_last)=x.equal_range(key(*it));
...
inline dgboost::mpl::true_* boost_foreach_is_noncopyable(
  dgboost::multi_index::detail::hashed_index<
