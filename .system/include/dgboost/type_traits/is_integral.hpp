...
template<> struct is_integral< ::dgboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::dgboost::long_long_type> : public true_type{};
...
template<> struct is_integral<dgboost::int128_type> : public true_type{};
template<> struct is_integral<dgboost::uint128_type> : public true_type{};
#endif
