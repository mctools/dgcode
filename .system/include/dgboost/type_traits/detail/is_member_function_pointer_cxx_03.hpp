...
#define BOOST_TT_IS_MEMBER_FUNCTION_POINTER_CXX_03_HPP_INCLUDED
   ...
   //
#   include <dgboost/type_traits/detail/is_mem_fun_pointer_impl.hpp>
...
#   include <dgboost/type_traits/detail/is_mem_fun_pointer_tester.hpp>
#endif
...
template <class T> struct is_member_function_pointer 
   : public ::dgboost::integral_constant<bool, ::dgboost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value>{};
...
#pragma warning(disable:6334)
        ...
        BOOST_STATIC_CONSTANT(
            bool, value = (
                1 == sizeof(::dgboost::type_traits::is_mem_fun_pointer_tester(self_type::make_t))
            ));
#if BOOST_WORKAROUND(BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select< 
      ::dgboost::is_reference<T>::value || ::dgboost::is_array<T>::value>::template result_<T>{};
...
struct is_member_function_pointer
   : public integral_constant<bool, ::dgboost::detail::is_member_function_pointer_impl<T>::value>{};
