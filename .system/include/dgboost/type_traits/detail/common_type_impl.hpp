...
#include <dgboost/type_traits/detail/common_arithmetic_type.hpp>
#include <dgboost/type_traits/detail/composite_pointer_type.hpp>
#include <dgboost/type_traits/detail/composite_member_pointer_type.hpp>
...
{
    BOOST_STATIC_CONSTANT( bool, ct = dgboost::is_class<T>::value || dgboost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = dgboost::is_class<U>::value || dgboost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public dgboost::conditional<

    dgboost::is_convertible<T, U>::value && !dgboost::is_convertible<U, T>::value,
    dgboost::type_identity<U>,

    typename dgboost::conditional<

        dgboost::is_convertible<U, T>::value && !dgboost::is_convertible<T, U>::value,
        dgboost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public dgboost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public dgboost::conditional<
    dgboost::is_pointer<T>::value || dgboost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public dgboost::conditional<
    dgboost::is_member_pointer<T>::value || dgboost::is_member_pointer<U>::value,
