...
//
#define PP1 <dgboost/preprocessor/iterate.hpp>
#define PP2 <dgboost/preprocessor/enum_params.hpp>
#define PP3 <dgboost/preprocessor/comma_if.hpp>
#include PP1
#include PP2
#include PP3
#undef PP1
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3, (0, 25, "dgboost/type_traits/detail/is_function_ptr_tester.hpp"))
