...
{
private:
   BOOST_STATIC_ASSERT_MSG((::dgboost::is_integral<T>::value || ::dgboost::is_enum<T>::value), "The template argument to make_unsigned must be an integer or enum type.");
   BOOST_STATIC_ASSERT_MSG((! ::dgboost::is_same<typename remove_cv<T>::type, bool>::value), "The template argument to make_unsigned must not be the type bool");

   typedef typename remove_cv<T>::type t_no_cv;
   typedef typename conditional<
      (::dgboost::is_unsigned<T>::value && ::dgboost::is_integral<T>::value 
      && ! ::dgboost::is_same<t_no_cv, char>::value
      && ! ::dgboost::is_same<t_no_cv, wchar_t>::value
      && ! ::dgboost::is_same<t_no_cv, bool>::value),
      T,
      typename conditional<
         (::dgboost::is_integral<T>::value 
         && ! ::dgboost::is_same<t_no_cv, char>::value
         && ! ::dgboost::is_same<t_no_cv, wchar_t>::value
         && ! ::dgboost::is_same<t_no_cv, bool>::value),
         typename conditional<
            ...
            typename conditional<
               ...
               typename conditional<
                  ...
                  typename conditional<
                     ...
                     typename conditional<
                        sizeof(t_no_cv) == sizeof(dgboost::ulong_long_type), 
                        dgboost::ulong_long_type, 
                        dgboost::uint128_type
                     >::type
#else
                     dgboost::ulong_long_type
#endif
