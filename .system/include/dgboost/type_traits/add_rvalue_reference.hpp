...
namespace type_traits_detail {
    ...
    {
       typedef typename dgboost::type_traits_detail::add_rvalue_reference_helper
...
{
   typedef typename dgboost::type_traits_detail::add_rvalue_reference_imp<T>::type type;
};
