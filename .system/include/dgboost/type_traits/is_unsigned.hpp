...
{
   BOOST_STATIC_CONSTANT(bool, value = (::dgboost::detail::is_unsigned_values<T>::minus_one > ::dgboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::dgboost::detail::is_unsigned_select_helper< ::dgboost::is_integral<T>::value || ::dgboost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, dgboost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::dgboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::dgboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::dgboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::dgboost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::dgboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::dgboost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::dgboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::dgboost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
