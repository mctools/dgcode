...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      /* bool */\
      ::dgboost::is_same< bool, Lhs_nocv >::value || \
      /* void* */\
      (\
      ...
      /* Arrays */ \
      ::dgboost::is_array<Lhs_noref>::value\
      )


#include <dgboost/type_traits/detail/has_postfix_operator.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
   ...
   template <>
   struct has_post_decrement<bool, dgboost::binary_op_detail::dont_care> : public false_type {};
   template <>
