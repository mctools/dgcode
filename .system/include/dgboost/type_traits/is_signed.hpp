...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::dgboost::detail::is_signed_values<T>::minus_one  > dgboost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::dgboost::detail::is_signed_select_helper< ::dgboost::is_integral<T>::value || ::dgboost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, dgboost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::dgboost::long_long_type> : public true_type{};
template <> struct is_signed<const ::dgboost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::dgboost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::dgboost::long_long_type> : public true_type{};

template <> struct is_signed< ::dgboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::dgboost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::dgboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::dgboost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
