...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<dgboost::is_void<From>, dgboost::is_function<To>, dgboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(dgboost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::dgboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::dgboost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_lvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::dgboost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static dgboost::type_traits::no_type _m_check(any_conversion ...);
    static dgboost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( dgboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::dgboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( dgboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::dgboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::dgboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::dgboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::dgboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::dgboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::dgboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::dgboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::dgboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::dgboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::dgboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::dgboost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::dgboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::dgboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::dgboost::is_function<typename ::dgboost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::dgboost::detail::is_convertible_basic_impl<From,To>::value && ! ::dgboost::is_array<To>::value && ! ::dgboost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::dgboost::detail::is_convertible_basic_impl<From, To>::value && !::dgboost::is_array<To>::value && !::dgboost::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::dgboost::is_arithmetic<From>::value, 
      ::dgboost::is_arithmetic<To>::value,
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::dgboost::detail::is_convertible_impl_dispatch<From, To>::value> 
{
   BOOST_STATIC_ASSERT_MSG(dgboost::is_complete<To>::value || dgboost::is_void<To>::value || dgboost::is_array<To>::value, "Destination argument type to is_convertible must be a complete type");
   BOOST_STATIC_ASSERT_MSG(dgboost::is_complete<From>::value || dgboost::is_void<From>::value || dgboost::is_array<From>::value, "From argument type to is_convertible must be a complete type");
};
...
struct is_convertible : public integral_constant<bool, BOOST_IS_CONVERTIBLE(From, To)> 
{
   ...
   BOOST_STATIC_ASSERT_MSG(dgboost::is_complete<From>::value || dgboost::is_void<From>::value || dgboost::is_array<From>::value || dgboost::is_reference<From>::value, "From argument type to is_convertible must be a complete type");
#endif
