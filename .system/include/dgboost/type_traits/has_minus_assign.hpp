...
namespace dgboost {} namespace boost = dgboost; namespace dgboost
{
   ...
   namespace binary_op_detail {
      ...
      struct has_minus_assign_ret_imp : public dgboost::false_type {};

      template <class T, class U, class Ret>
      struct has_minus_assign_ret_imp<T, U, Ret, typename dgboost::make_void<decltype(std::declval<typename add_reference<T>::type>() -= std::declval<typename add_reference<U>::type>())>::type>
      ...
      struct has_minus_assign_void_imp : public dgboost::false_type {};

      template <class T, class U>
      struct has_minus_assign_void_imp<T, U, typename dgboost::make_void<decltype(std::declval<typename add_reference<T>::type>() -= std::declval<typename add_reference<U>::type>())>::type>
      ...
      template <class T, class U, class = void>
      struct has_minus_assign_dc_imp : public dgboost::false_type {};

      template <class T, class U>
      struct has_minus_assign_dc_imp<T, U, typename dgboost::make_void<decltype(std::declval<typename add_reference<T>::type>() -= std::declval<typename add_reference<U>::type>())>::type>
         : public dgboost::true_type {};

      template <class T, class U, class Ret>
      struct has_minus_assign_ret_filter : public dgboost::binary_op_detail::has_minus_assign_ret_imp <T, U, Ret> {};
      template <class T, class U>
      struct has_minus_assign_ret_filter<T, U, void> : public dgboost::binary_op_detail::has_minus_assign_void_imp <T, U> {};
      template <class T, class U>
      struct has_minus_assign_ret_filter<T, U, dgboost::binary_op_detail::dont_care> : public dgboost::binary_op_detail::has_minus_assign_dc_imp <T, U> {};

      template <class T, class U, class Ret, bool b>
      struct has_minus_assign_void_ptr_filter : public dgboost::binary_op_detail::has_minus_assign_ret_filter <T, U, Ret> {};
      template <class T, class U, class Ret>
      struct has_minus_assign_void_ptr_filter<T, U, Ret, true> : public dgboost::false_type {};

   }

   template <class T, class U = T, class Ret = dgboost::binary_op_detail::dont_care>
   struct has_minus_assign :
      public dgboost::binary_op_detail::has_minus_assign_void_ptr_filter<
      T, U, Ret,
      ...
      || (dgboost::is_pointer<typename remove_reference<T>::type>::value && dgboost::is_pointer<typename remove_reference<U>::type>::value)> {};
