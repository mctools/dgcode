...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(dgboost::declval<typename add_reference<T>::type>() = dgboost::declval<typename add_reference<T const>::type>()); };
   ...
   struct has_nothrow_assign : public integral_constant < bool,
      ...
      >::value
#else
      ::dgboost::has_trivial_assign<T>::value
#endif
#else
