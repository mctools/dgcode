...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename dgboost::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   {
      typedef dgboost::integral_constant<bool, (dgboost::is_base_of<Base, Derived>::value && !dgboost::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::dgboost::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
