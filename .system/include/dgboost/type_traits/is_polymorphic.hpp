...
{
   typedef is_polymorphic_selector< ::dgboost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::dgboost::detail::is_polymorphic_imp<T>::value> {};
