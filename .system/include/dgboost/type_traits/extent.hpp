...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::dgboost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::dgboost::integral_constant<std::size_t, ::dgboost::detail::extent_imp<T,N>::value>
{
};
