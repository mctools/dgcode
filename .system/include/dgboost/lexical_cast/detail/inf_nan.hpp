...
#include <dgboost/math/special_functions/sign.hpp>
    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) BOOST_NOEXCEPT
        {
            ...
            if (lc_iequal(begin, lc_nan, lc_NAN, 3)) {
                ...
                else value = (dgboost::math::changesign) (std::numeric_limits<T>::quiet_NaN());
                return true;
            } else if (
                ( /* 'INF' or 'inf' */
             ...
             )
            {
                ...
                else value = (dgboost::math::changesign) (std::numeric_limits<T>::infinity());
                return true;
            }
                         ...
                         , const CharT* lc_infinity) BOOST_NOEXCEPT
        {
            using namespace std;
            const CharT minus = lcast_char_constants<CharT>::minus;
            if ((dgboost::math::isnan)(value)) {
                if ((dgboost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
                ...
                return true;
            } else if ((dgboost::math::isinf)(value)) {
                if ((dgboost::math::signbit)(value)) {
                    *begin = minus;
                    ++ begin;
                }
