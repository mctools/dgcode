...
# define BOOST_SP_INTERLOCKED_INCREMENT ::dgboost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::dgboost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::dgboost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::dgboost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::dgboost::detail::InterlockedExchangeAdd
