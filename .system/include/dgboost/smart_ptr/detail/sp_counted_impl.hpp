...
#include <dgboost/smart_ptr/detail/quick_allocator.hpp>
#endif
...
public:
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        dgboost::sp_scalar_constructor_hook( px, sizeof(X), this );
#endif
    }
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        dgboost::sp_scalar_destructor_hook( px_, sizeof(X), this );
#endif
        dgboost::checked_delete( px_ );
    }
...
public:
    ...
    {
        return ti == BOOST_SP_TYPEID_(D)? dgboost::detail::get_local_deleter( dgboost::addressof( del ) ): 0;
    }
...
public:
    ...
    virtual void * get_local_deleter( sp_typeinfo_ const & ti ) BOOST_SP_NOEXCEPT
    {
        return ti == BOOST_SP_TYPEID_( D )? dgboost::detail::get_local_deleter( dgboost::addressof( d_ ) ): 0;
    }
