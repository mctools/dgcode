...
#include <dgboost/iterator/interoperable.hpp>
#include <dgboost/iterator/iterator_traits.hpp>
#include <dgboost/iterator/iterator_categories.hpp>

#include <dgboost/iterator/detail/facade_iterator_category.hpp>
#include <dgboost/iterator/detail/enable_if.hpp>
...
#include <dgboost/iterator/detail/config_def.hpp> // this goes last
...
namespace iterators {
  ...
  namespace detail
  {
    ...
    struct is_traversal_at_least :
        public dgboost::is_convertible< typename iterator_category_to_traversal< CategoryOrTraversal >::type, Required >
    {};
    ...
    struct enable_if_interoperable :
        public dgboost::iterators::enable_if<
    ...
    struct iterator_facade_types
    {
        ...
        typedef typename mpl::eval_if<
            dgboost::iterators::detail::iterator_writability_disabled<ValueParam,Reference>
...
# endif
    ...
    struct operator_arrow_dispatch // proxy references
    {
        struct proxy
        {
            ...
            Reference* operator->() { return dgboost::addressof(m_ref); }
            // This function is needed for MWCW and BCC, which won't call
            // operator-> again automatically per 13.3.1.2 para 8
            operator Reference*() { return dgboost::addressof(m_ref); }
            Reference m_ref;
        };
...
#  define BOOST_ITERATOR_FACADE_INTEROP_HEAD(prefix, op, result_type)       \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD_IMPL(prefix, op, result_type, dgboost::iterators::detail::enable_if_interoperable)

#  define BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(prefix, op, result_type)       \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD_IMPL(prefix, op, result_type, dgboost::iterators::detail::enable_if_interoperable_and_random_access_traversal)

#  define BOOST_ITERATOR_FACADE_PLUS_HEAD(prefix,args)              \
    template <class Derived, class V, class TC, class R, class D>   \
    prefix typename dgboost::iterators::enable_if<                    \
        dgboost::iterators::detail::is_traversal_at_least< TC, dgboost::iterators::random_access_traversal_tag >,  \
        Derived                                                     \
    >::type operator+ args
...
#  define BOOST_ITERATOR_FACADE_RELATION(op)                                \
      BOOST_ITERATOR_FACADE_INTEROP_HEAD(friend,op, dgboost::iterators::detail::always_bool2);
...
#  define BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION(op)                                \
      BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(friend,op, dgboost::iterators::detail::always_bool2);
...
#  undef BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION
      ...
      BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(
          friend, -, dgboost::iterators::detail::choose_difference_type)
      ;
...
# ifdef BOOST_ITERATOR_FACADE_NEEDS_ITERATOR_BASE
        : public dgboost::iterators::detail::iterator_facade_types<
...
# endif
    {
    private:
        typedef dgboost::iterators::detail::iterator_facade_types<
            Value, CategoryOrTraversal, Reference, Difference
        > associated_types;

        typedef dgboost::iterators::detail::operator_arrow_dispatch<
            Reference
    ...
    public:
        typename dgboost::iterators::detail::operator_brackets_result<Derived, Value, reference>::type
        operator[](difference_type n) const
        {
            typedef dgboost::iterators::detail::use_operator_brackets_proxy<Value, Reference> use_proxy;

            return dgboost::iterators::detail::make_operator_brackets_result<Derived>(
                this->derived() + n
              , use_proxy()
            );
        }
  ...
  template <class I, class V, class TC, class R, class D>
  inline typename dgboost::iterators::detail::postfix_increment_result<I,V,R,TC>::type
  operator++(
      iterator_facade<I,V,TC,R,D>& i
    , int
  )
  {
      typename dgboost::iterators::detail::postfix_increment_result<I,V,R,TC>::type
          tmp(*static_cast<I*>(&i));
  ...
  // (aka. enable_if) and dgboost::is_convertible is required.
  //
...
# define BOOST_ITERATOR_FACADE_RELATION(op, return_prefix, base_op) \
  BOOST_ITERATOR_FACADE_INTEROP(                                    \
      op                                                            \
    , dgboost::iterators::detail::always_bool2                                   \
    , return_prefix                                                 \
    , base_op                                                       \
  )
...
# define BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS(op, result_type, return_prefix, base_op) \
  ...
  {                                                                             \
      ...
      BOOST_STATIC_ASSERT((                                                     \
          is_interoperable< Derived1, Derived2 >::value &&                      \
          dgboost::iterators::detail::is_traversal_at_least< typename iterator_category< Derived1 >::type, random_access_traversal_tag >::value && \
          dgboost::iterators::detail::is_traversal_at_least< typename iterator_category< Derived2 >::type, random_access_traversal_tag >::value \
      ));                                                                       \
      return_prefix iterator_core_access::base_op(                              \
          *static_cast<Derived1 const*>(&lhs)                                   \
        , *static_cast<Derived2 const*>(&rhs)                                   \
...
# undef BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION
  ...
  BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS(
      -
    , dgboost::iterators::detail::choose_difference_type
    , return
    , distance_from
  )
...
#include <dgboost/iterator/detail/config_undef.hpp>
