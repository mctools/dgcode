...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parameter { 
    ...
    struct value_type0
    {
        ...
        using type = ::dgboost::mp11::mp_apply_q<
          ...
          , ::dgboost::mp11::mp_list<Keyword,Default,::dgboost::mp11::mp_false>
        >;
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parameter { 
    ...
    struct value_type
      ...
      : ::dgboost::mpl::eval_if<
          ...
          , ::dgboost::parameter::value_type0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::dgboost::mp11::mp_if<
          ...
          , ::dgboost::mp11::mp_if<
              ...
              , ::dgboost::parameter::value_type1<Parameters,Keyword,Default>
              , ::dgboost::parameter::value_type0<Parameters,Keyword,Default>
            >
        >::type;
#endif
