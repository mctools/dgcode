...
#define BOOST_PARAMETER_NAME_TAG(tag_namespace, tag, q)                      \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            using qualifier = ::dgboost::parameter::q;                         \
        };                                                                   \
    }
/**/
...
#define BOOST_PARAMETER_NAME_TAG(tag_namespace, tag, q)                      \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            typedef ::dgboost::parameter::q qualifier;                         \
        };                                                                   \
    }
/**/
#endif  // BOOST_PARAMETER_CAN_USE_MP11

#include <dgboost/parameter/keyword.hpp>

#define BOOST_PARAMETER_NAME_KEYWORD(tag_namespace, tag, name)               \
    namespace                                                                \
    {                                                                        \
        ::dgboost::parameter::keyword<tag_namespace::tag> const& name          \
            = ::dgboost::parameter::keyword<tag_namespace::tag>::instance;     \
    }
/**/
...
#include <dgboost/parameter/aux_/preprocessor/qualifier.hpp>
...
#include <dgboost/parameter/aux_/preprocessor/is_binary.hpp>
...
#include <dgboost/parameter/template_keyword.hpp>
