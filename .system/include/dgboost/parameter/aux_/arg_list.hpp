...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        struct tagged_arg
        {
            typedef ::dgboost::parameter::void_ value_type;
        };
        ...
        inline BOOST_CONSTEXPR Default&
            operator[](::dgboost::parameter::aux::default_<K,Default> x) const
        {
            return x.value;
        }
        ...
        template <typename K, typename Default>
        inline BOOST_CONSTEXPR Default&&
            operator[](::dgboost::parameter::aux::default_r_<K,Default> x) const
        {
        ...
        // MPL sequence support
        typedef ::dgboost::parameter::aux::empty_arg_list type; // convenience
...
#include <dgboost/parameter/aux_/yesno.hpp>
#include <dgboost/parameter/aux_/is_maybe.hpp>
#include <dgboost/parameter/aux_/tagged_argument_fwd.hpp>
#include <dgboost/parameter/aux_/parameter_requirements.hpp>
#include <dgboost/parameter/aux_/augment_predicate.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parameter { namespace aux {
    ...
    template <
        typename TaggedArg
      , typename Next = ::dgboost::parameter::aux::empty_arg_list
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
      , typename EmitsErrors = ::dgboost::mp11::mp_true
#else
      , typename EmitsErrors = ::dgboost::mpl::true_
#endif
    >
    class arg_list : public Next
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _holds_maybe = typename ::dgboost::parameter::aux
     ...
     public:
        ...
        typedef ::dgboost::parameter::aux::arg_list<TaggedArg,Next> self;
        typedef typename TaggedArg::key_type key_type;

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::dgboost::mp11::mp_if<
            _holds_maybe
          , ::dgboost::parameter::aux
            ::get_reference<typename TaggedArg::value_type>
          , ::dgboost::parameter::aux::get_reference<TaggedArg>
        >::type;

        using value_type = ::dgboost::mp11
        ...
        inline BOOST_CONSTEXPR arg_list(
            ::dgboost::parameter::aux::value_type_is_not_void
          , A0&& a0
        ) : Next(
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ::dgboost::mp11::mp_if<
                ...
                typename ::dgboost::mpl::if_<
                    ::dgboost::is_same<
                      ...
                      , ::dgboost::parameter::void_
                    >
                  , ::dgboost::parameter::aux::value_type_is_void
                  , ::dgboost::parameter::aux::value_type_is_not_void
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                >()
#else
        ...
        inline BOOST_CONSTEXPR arg_list(
          ...
          , arg(::dgboost::parameter::aux::void_reference())
        {
        }
        ...
        struct binding
        {
            ...
            using fn = ::dgboost::mp11::mp_if<
              ...
              , ::dgboost::mp11::mp_apply_q<
                    next_binding
                  , ::dgboost::mp11::mp_list<KW,Default,Reference>
                >
            >;
#endif
        };
     ...
     private:
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _has_unique_key = ::dgboost::mp11::mp_bool<
#else
        typedef ::dgboost::mpl::bool_<
            ...
            ) == sizeof(::dgboost::parameter::aux::no_tag)
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
        > _has_unique_key;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const&, ::dgboost::mp11::mp_false) const
#else
            get_default(D const&, ::dgboost::mpl::false_) const
#endif
        {
        ...
        inline BOOST_CONSTEXPR reference
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const& d, ::dgboost::mp11::mp_true) const
#else
            get_default(D const& d, ::dgboost::mpl::true_) const
#endif
        {
            return (
                this->arg.get_value()
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::dgboost::parameter::aux::default_<key_type,Default> const& d
            ) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::dgboost::parameter::aux::default_r_<key_type,Default> const& d
            ) const
        {
            return this->get_default(d, _holds_maybe());
        }
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        static typename ::dgboost::lazy_enable_if<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::dgboost::mp11::mp_if<
                EmitsErrors
              ...
              , _has_unique_key
            >
          , ::dgboost::parameter::aux::augment_predicate_mp11<
#else
            typename ::dgboost::mpl::if_<
                EmitsErrors
              , ::dgboost::mpl::true_
              , _has_unique_key
            >::type
          , ::dgboost::parameter::aux::augment_predicate<
#endif
                Predicate
              , reference
              , key_type
        ...
        inline BOOST_CONSTEXPR ::dgboost::parameter::aux::arg_list<
            ::dgboost::parameter::aux::tagged_argument<KW,T2>
          , self
        >
            operator,(
                ::dgboost::parameter::aux::tagged_argument<KW,T2> const& x
            ) const
        {
        ...
        template <typename KW, typename T2>
        inline BOOST_CONSTEXPR ::dgboost::parameter::aux::arg_list<
            ::dgboost::parameter::aux::tagged_argument_rref<KW,T2>
          , self
        >
            operator,(
                ::dgboost::parameter::aux::tagged_argument_rref<KW,T2> const& x
            ) const
        {
            return ::dgboost::parameter::aux::arg_list<
                ::dgboost::parameter::aux::tagged_argument_rref<KW,T2>
...
#include <dgboost/preprocessor/facilities/intercept.hpp>
    ...
    struct empty_arg_list
    {
        ...
        inline BOOST_CONSTEXPR empty_arg_list(
            BOOST_PP_ENUM_PARAMS(
              ...
              , ::dgboost::parameter::void_ BOOST_PP_INTERCEPT
            )
        )
        {
        }
...
#include <dgboost/preprocessor/repetition/enum_shifted_params.hpp>
    ...
    class arg_list : public Next
    {
     ...
     public:
        ...
        inline BOOST_CONSTEXPR arg_list(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(
              ...
              , ::dgboost::parameter::aux::void_reference()
            )
          , arg(a0)
        {
        }
     ...
     public:
            ...
            struct apply
            {
                typedef typename ::dgboost::mpl::eval_if<
                  ...
                  , ::dgboost::mpl::identity<
                        ::dgboost::parameter::aux::arg_list<TaggedArg,Next>
                    >
                  , ::dgboost::mpl::apply_wrap1<next_key_owner,KW>
                >::type type;
            };
        };
        ...
        inline BOOST_CONSTEXPR typename ::dgboost::mpl::apply_wrap3<
          ...
          , ::dgboost::mpl::true_
        >::type
            operator[](::dgboost::parameter::keyword<KW> const& x) const
        {
            typename ::dgboost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        // fails.
        inline BOOST_CONSTEXPR reference
            get(::dgboost::parameter::keyword<key_type> const&) const
        {
            BOOST_MPL_ASSERT_NOT((_holds_maybe));
            return this->arg.get_value();
        }
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parameter { namespace aux {
    ...
    struct arg_list_cons<>
    {
        using type = ::dgboost::parameter::aux::empty_arg_list;
    };

    template <typename ArgTuple0, typename ...Tuples>
    struct arg_list_cons<ArgTuple0,Tuples...>
    {
        using type = ::dgboost::parameter::aux::arg_list<
            typename ArgTuple0::tagged_arg
          , typename ::dgboost::parameter::aux::arg_list_cons<Tuples...>::type
    ...
    class flat_like_arg_list
      : public ::dgboost::parameter::aux::arg_list_cons<ArgTuples...>::type
    {
        using _base_type = typename ::dgboost::parameter::aux
    ...
    template <>
    class flat_like_arg_list<>
      : public ::dgboost::parameter::aux::empty_arg_list
    {
        using _base_type = ::dgboost::parameter::aux::empty_arg_list;
...
#include <dgboost/mpl/iterator_tags.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace parameter { namespace aux {
    ...
    {
        typedef ::dgboost::mpl::forward_iterator_tag category;
    ...
    template <>
    struct arg_list_iterator< ::dgboost::parameter::aux::empty_arg_list>
    {
    };
}}} // namespace dgboost::parameter::aux

#include <dgboost/mpl/begin_end_fwd.hpp>

// MPL sequence support
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct begin_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
        template <typename S>
        struct apply
        {
            typedef ::dgboost::parameter::aux::arg_list_iterator<S> type;
        };
    };

    template <>
    struct end_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
        template <typename>
        struct apply
        {
            typedef ::dgboost::parameter::aux::arg_list_iterator<
...
#include <dgboost/mpl/has_key_fwd.hpp>
#include <dgboost/type_traits/is_void.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct has_key_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
...
#include <dgboost/mpl/count_fwd.hpp>
#include <dgboost/mpl/int.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct count_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
#include <dgboost/mpl/key_type_fwd.hpp>
#include <dgboost/mpl/identity.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct key_type_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
...
#include <dgboost/mpl/value_type_fwd.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct value_type_impl< ::dgboost::parameter::aux::arg_list_tag>
      : ::dgboost::mpl::key_type_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace dgboost::mpl

#include <dgboost/mpl/at_fwd.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct at_impl< ::dgboost::parameter::aux::arg_list_tag>
      : ::dgboost::mpl::key_type_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace dgboost::mpl

#include <dgboost/mpl/order_fwd.hpp>
#include <dgboost/mpl/void.hpp>
#include <dgboost/mpl/find.hpp>
#include <dgboost/mpl/distance.hpp>

namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace mpl {

    template <>
    struct order_impl< ::dgboost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::dgboost::mpl::find<ArgList,Keyword>::type Itr;
            typedef typename ::dgboost::mpl::eval_if<
                ::dgboost::is_void<
                    typename ::dgboost::parameter
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::dgboost::mpl::identity< ::dgboost::mpl::void_>
              , ::dgboost::mpl::distance<
                    Itr
                  , ::dgboost::parameter::aux::arg_list_iterator<
                        ::dgboost::parameter::aux::empty_arg_list
                    >
                >
            >::type type;
