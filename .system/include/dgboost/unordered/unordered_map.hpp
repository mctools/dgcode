...
#include <dgboost/core/explicit_operator_bool.hpp>
#include <dgboost/functional/hash.hpp>
#include <dgboost/move/move.hpp>
#include <dgboost/type_traits/is_constructible.hpp>
#include <dgboost/unordered/detail/map.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    ...
    private:
      typedef dgboost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
      ...
      unordered_map(InputIt, InputIt,
        size_type = dgboost::unordered::detail::default_bucket_count,
  ...
  !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
      unordered_map(BOOST_RV_REF(unordered_map) other)
        BOOST_NOEXCEPT_IF(table::nothrow_move_constructible)
          : table_(other.table_, dgboost::unordered::detail::move_tag())
      {
...
// Assign
      ...
      {
        table_.assign(x.table_, dgboost::unordered::detail::true_type());
        return *this;
      }
      ...
      {
        table_.move_assign(x.table_, dgboost::unordered::detail::true_type());
        return *this;
      }
#else
...
// emplace
      ...
      std::pair<iterator, bool> emplace(BOOST_FWD_REF(Args)... args)
      {
        return table_.emplace_unique(
          table::extractor::extract(dgboost::forward<Args>(args)...),
          dgboost::forward<Args>(args)...);
      }
      ...
      std::pair<iterator, bool> emplace(
        dgboost::unordered::detail::empty_emplace =
          dgboost::unordered::detail::empty_emplace(),
        value_type v = value_type())
      {
        return this->emplace(dgboost::move(v));
      }
      ...
      {
        return table_.emplace_unique(
          table::extractor::extract(dgboost::forward<A0>(a0)),
          dgboost::unordered::detail::create_emplace_args(
            dgboost::forward<A0>(a0)));
      }
        ...
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1)
      {
        return table_.emplace_unique(
          table::extractor::extract(
            dgboost::forward<A0>(a0), dgboost::forward<A1>(a1)),
          dgboost::unordered::detail::create_emplace_args(
            dgboost::forward<A0>(a0), dgboost::forward<A1>(a1)));
      }
        ...
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
      {
        return table_.emplace_unique(
          table::extractor::extract(
            dgboost::forward<A0>(a0), dgboost::forward<A1>(a1)),
          dgboost::unordered::detail::create_emplace_args(dgboost::forward<A0>(a0),
            dgboost::forward<A1>(a1), dgboost::forward<A2>(a2)));
      }
      ...
      iterator emplace_hint(const_iterator hint,
        ...
        value_type v = value_type())
      {
        return this->emplace_hint(hint, dgboost::move(v));
      }
...
#undef BOOST_UNORDERED_EMPLACE
      ...
      {
        return this->emplace(dgboost::move(x));
      }

      template <class P2>
      typename dgboost::enable_if<
        dgboost::is_constructible<value_type, BOOST_RV_REF(P2)>,
        std::pair<iterator, bool> >::type insert(BOOST_RV_REF(P2) obj)
      {
        return this->emplace(dgboost::forward<P2>(obj));
      }
      ...
      {
        return this->emplace_hint(hint, dgboost::move(x));
      }

      template <class P2>
      typename dgboost::enable_if<
        dgboost::is_constructible<value_type, BOOST_RV_REF(P2)>, iterator>::type
      insert(const_iterator hint, BOOST_RV_REF(P2) obj)
      {
        return this->emplace_hint(hint, dgboost::forward<P2>(obj));
      }
      ...
      {
        return node_type(table_.extract_by_key_impl(dgboost::forward<Key>(k)),
          table_.node_alloc());
      }
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    public:
      ...
      {
        return table_.try_emplace_unique(k, dgboost::forward<Args>(args)...);
      }
        ...
        BOOST_RV_REF(key_type) k, BOOST_FWD_REF(Args)... args)
      {
        return table_.try_emplace_unique(
          dgboost::move(k), dgboost::forward<Args>(args)...);
      }
        ...
        const_iterator hint, key_type const& k, BOOST_FWD_REF(Args)... args)
      {
        return table_.try_emplace_hint_unique(
          hint, k, dgboost::forward<Args>(args)...);
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, dgboost::move(k), dgboost::forward<Args>(args)...);
      }
      ...
      {
        return table_.try_emplace_unique(dgboost::forward<Key>(k));
      }
      ...
      {
        return table_.try_emplace_hint_unique(hint, dgboost::forward<Key>(k));
      }
      ...
      {
        return table_.try_emplace_unique(
          k, dgboost::unordered::detail::create_emplace_args(
               dgboost::forward<A0>(a0)));
      }
      ...
      {
        return table_.try_emplace_unique(
          dgboost::move(k), dgboost::unordered::detail::create_emplace_args(
                            dgboost::forward<A0>(a0)));
      }
      ...
      std::pair<iterator, bool> try_emplace(BOOST_RV_REF(key_type) k,
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
      {
        return table_.try_emplace_unique(dgboost::move(k),
          dgboost::unordered::detail::create_emplace_args(dgboost::forward<A0>(a0),
            dgboost::forward<A1>(a1), dgboost::forward<A2>(a2)));
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, k, dgboost::unordered::detail::create_emplace_args(
                     dgboost::forward<A0>(a0)));
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, dgboost::move(k), dgboost::unordered::detail::create_emplace_args(
                                  dgboost::forward<A0>(a0)));
      }
      ...
      iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k,
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1)
      {
        return table_.try_emplace_hint_unique(hint, dgboost::move(k),
          dgboost::unordered::detail::create_emplace_args(
            dgboost::forward<A0>(a0), dgboost::forward<A1>(a1)));
      }
...
#undef BOOST_UNORDERED_TRY_EMPLACE
      ...
      {
        return table_.insert_or_assign_unique(k, dgboost::forward<M>(obj));
      }
        ...
        BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
      {
        return table_.insert_or_assign_unique(
          dgboost::move(k), dgboost::forward<M>(obj));
      }
      ...
      {
        return table_.insert_or_assign_unique(k, dgboost::forward<M>(obj)).first;
      }
      ...
      {
        return table_
          .insert_or_assign_unique(dgboost::move(k), dgboost::forward<M>(obj))
          .first;
      }
      ...
      {
        return table_.erase_key_unique_impl(dgboost::forward<Key>(k));
      }
      ...
      void merge(dgboost::unordered_map<K, T, H2, P2, A>& source);
      ...
      template <typename H2, typename P2>
      void merge(dgboost::unordered_multimap<K, T, H2, P2, A>& source);
      ...
      template <class Key>
      typename dgboost::enable_if_c<detail::are_transparent<Key, H, P>::value,
        iterator>::type
      find(const Key& key)
      {
    ...
    template <class InputIterator,
      class Hash =
        dgboost::hash<dgboost::unordered::detail::iter_key_t<InputIterator> >,
      class Pred =
        std::equal_to<dgboost::unordered::detail::iter_key_t<InputIterator> >,
      class Allocator = std::allocator<
        dgboost::unordered::detail::iter_to_alloc_t<InputIterator> > >
    unordered_map(InputIterator, InputIterator,
      std::size_t = dgboost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      ->unordered_map<dgboost::unordered::detail::iter_key_t<InputIterator>,
        dgboost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;

    template <class Key, class T, class Hash = dgboost::hash<Key>,
    ...
    unordered_map(InputIterator, InputIterator, std::size_t, Allocator)
      ->unordered_map<dgboost::unordered::detail::iter_key_t<InputIterator>,
        dgboost::unordered::detail::iter_val_t<InputIterator>,
        dgboost::hash<dgboost::unordered::detail::iter_key_t<InputIterator> >,
        std::equal_to<dgboost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_map(InputIterator, InputIterator, std::size_t, Hash, Allocator)
      ->unordered_map<dgboost::unordered::detail::iter_key_t<InputIterator>,
        dgboost::unordered::detail::iter_val_t<InputIterator>, Hash,
        std::equal_to<dgboost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_map(
      ...
      ->unordered_map<Key, T, dgboost::hash<Key>, std::equal_to<Key>, Allocator>;
...
// Assign
      ...
      {
        table_.assign(x.table_, dgboost::unordered::detail::false_type());
        return *this;
      }
      ...
      unordered_multimap& operator=(BOOST_RV_REF(unordered_multimap) x)
        BOOST_NOEXCEPT_IF(value_allocator_traits::is_always_equal::value&&
            dgboost::is_nothrow_move_assignable<H>::value&&
              dgboost::is_nothrow_move_assignable<P>::value)
      {
        table_.move_assign(x.table_, dgboost::unordered::detail::false_type());
        return *this;
      }
#else
...
// emplace
      ...
      template <class... Args> iterator emplace(BOOST_FWD_REF(Args)... args)
      {
        return iterator(table_.emplace_equiv(
          dgboost::unordered::detail::func::construct_node_from_args(
            table_.node_alloc(), dgboost::forward<Args>(args)...)));
      }
      ...
      iterator emplace(dgboost::unordered::detail::empty_emplace =
                         dgboost::unordered::detail::empty_emplace(),
        value_type v = value_type())
      {
        return this->emplace(dgboost::move(v));
      ...
      template <typename A0> iterator emplace(BOOST_FWD_REF(A0) a0)
      {
        return iterator(table_.emplace_equiv(
          dgboost::unordered::detail::func::construct_node_from_args(
            table_.node_alloc(), dgboost::unordered::detail::create_emplace_args(
                                   dgboost::forward<A0>(a0)))));
      }
      ...
      iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
      {
        return iterator(table_.emplace_hint_equiv(
          hint, dgboost::unordered::detail::func::construct_node_from_args(
                  table_.node_alloc(), dgboost::forward<Args>(args)...)));
      }
...
#undef BOOST_UNORDERED_EMPLACE
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    public:
      ...
      erase(BOOST_FWD_REF(Key) k)
      {
        return table_.erase_key_equiv_impl(dgboost::forward<Key>(k));
      }
    ...
    unordered_multimap(InputIterator, InputIterator,
      std::size_t = dgboost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      ->unordered_multimap<dgboost::unordered::detail::iter_key_t<InputIterator>,
        dgboost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;
    ...
    unordered_multimap(
      std::initializer_list<std::pair<const Key, T> >, std::size_t, Allocator)
      ->unordered_multimap<Key, T, dgboost::hash<Key>, std::equal_to<Key>,
        Allocator>;
    ...
    unordered_map<K, T, H, P, A>::unordered_map()
        : table_(dgboost::unordered::detail::default_bucket_count, hasher(),
    ...
    unordered_map<K, T, H, P, A>::unordered_map(InputIt f, InputIt l,
      ...
      const allocator_type& a)
        : table_(dgboost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
      this->insert(f, l);
    }
              ...
              select_on_container_copy_construction(other.get_allocator()))
    {
      if (other.size()) {
        table_.copy_buckets(
          other.table_, dgboost::unordered::detail::true_type());
      }
    }
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      BOOST_RV_REF(unordered_map) other, allocator_type const& a)
        : table_(other.table_, a, dgboost::unordered::detail::move_tag())
    {
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      ...
      const key_equal& eql, const allocator_type& a)
        : table_(
            dgboost::unordered::detail::initial_size(list.begin(), list.end(), n),
            hf, eql, a)
    {
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      InputIt f, InputIt l, size_type n, const allocator_type& a)
        : table_(dgboost::unordered::detail::initial_size(f, l, n), hasher(),
            key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    unordered_map<K, T, H, P, A>::unordered_map(InputIt f, InputIt l,
      size_type n, const hasher& hf, const allocator_type& a)
        : table_(
            dgboost::unordered::detail::initial_size(f, l, n), hf, key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    std::size_t unordered_map<K, T, H, P, A>::max_size() const BOOST_NOEXCEPT
    {
      ...
      // size <= mlf_ * count
      return dgboost::unordered::detail::double_to_size(
    ...
    void unordered_map<K, T, H, P, A>::merge(
      dgboost::unordered_map<K, T, H2, P2, A>& source)
    {
    ...
    template <typename H2, typename P2>
    void unordered_map<K, T, H, P, A>::merge(
      dgboost::unordered_multimap<K, T, H2, P2, A>& source)
    {
      table_.merge_unique(source.table_);
    }
    ...
    {
      return table_.try_emplace_unique(dgboost::move(k)).first->second;
    }
              ...
              select_on_container_copy_construction(other.get_allocator()))
    {
      if (other.table_.size_) {
        table_.copy_buckets(
          other.table_, dgboost::unordered::detail::false_type());
      }
    }
    ...
    template <typename N, class K, class T, class A> class node_handle_map
    {
      ...
      template <typename Types> friend struct ::dgboost::unordered::detail::table;
      template <class K2, class T2, class H2, class P2, class A2>
      friend class dgboost::unordered::unordered_map;
      template <class K2, class T2, class H2, class P2, class A2>
      friend class dgboost::unordered::unordered_multimap;

      typedef typename dgboost::allocator_rebind<A, std::pair<K const, T> >::type
        value_allocator;

      typedef N node;
      typedef typename dgboost::allocator_rebind<A, node>::type node_allocator;

      typedef
        typename dgboost::allocator_pointer<node_allocator>::type node_pointer;
    ...
    private:
      node_pointer ptr_;
      dgboost::unordered::detail::optional<value_allocator> alloc_;
    ...
    public:
      ...
      ~node_handle_map()
      {
        if (ptr_) {
          ...
          dgboost::unordered::detail::node_tmp<node_allocator> tmp(
            ptr_, node_alloc);
        }
      }
      ...
      void swap(node_handle_map& n) BOOST_NOEXCEPT_IF(
        dgboost::allocator_propagate_on_container_swap<
          value_allocator>::type::value ||
        dgboost::allocator_is_always_equal<value_allocator>::type::value)
      {
        ...
        BOOST_ASSERT(!alloc_.has_value() || !n.alloc_.has_value() ||
                     dgboost::allocator_propagate_on_container_swap<
                       value_allocator>::type::value ||
                     alloc_ == n.alloc_);
        if (dgboost::allocator_propagate_on_container_swap<
              value_allocator>::type::value ||
            !alloc_.has_value() || !n.alloc_.has_value()) {
          dgboost::swap(alloc_, n.alloc_);
        }
        dgboost::swap(ptr_, n.ptr_);
      }
    };
    ...
    private:
      ...
      // typedef typename dgboost::allocator_rebind<A,
    ...
    {
      dgboost::swap(x.node, y.node);
      dgboost::swap(x.inserted, y.inserted);
      dgboost::swap(x.position, y.position);
    }
  } // namespace unordered
} // namespace dgboost
