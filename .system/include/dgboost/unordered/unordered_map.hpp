...
#undef BOOST_UNORDERED_EMPLACE
      ...
      std::pair<iterator, bool> insert(BOOST_RV_REF(P2) obj,
        typename dgboost::enable_if_c<
          dgboost::is_constructible<value_type, BOOST_RV_REF(P2)>::value,
          void*>::type = 0)
      {
...
#undef BOOST_UNORDERED_EMPLACE
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    template <typename N, class K, class T, class A> class node_handle_map
    {
      ...
      typedef N node;
      typedef typename dgboost::unordered::detail::rebind_wrap<A, node>::type
        node_allocator;
    ...
    public:
      bool inserted;
      dgboost::unordered::iterator_detail::iterator<node_> position;
      dgboost::unordered::node_handle_map<N, K, T, A> node;
