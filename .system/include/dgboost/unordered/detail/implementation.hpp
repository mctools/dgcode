...
#include <dgboost/core/pointer_traits.hpp>
#include <dgboost/detail/select_type.hpp>
#include <dgboost/limits.hpp>
#include <dgboost/move/move.hpp>
...
#include <dgboost/preprocessor/repetition/repeat_from_to.hpp>
#include <dgboost/preprocessor/seq/enum.hpp>
#include <dgboost/preprocessor/seq/size.hpp>
...
#include <dgboost/utility/addressof.hpp>
...
// 2 = dgboost::container::allocator_traits
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    namespace detail {
      ...
      template <typename I>
      struct is_forward : dgboost::is_base_of<std::forward_iterator_tag,
      ...
      struct enable_if_forward
        : dgboost::enable_if_c<dgboost::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
      ...
      struct disable_if_forward
        : dgboost::disable_if_c<dgboost::unordered::detail::is_forward<I>::value,
            ReturnType>
      {
      };
    }
...
#undef BOOST_UNORDERED_PRIMES
      ...
      inline std::size_t insert_size(I i, I j,
        typename dgboost::unordered::detail::enable_if_forward<I, void*>::type =
          0)
      {
      ...
      inline std::size_t insert_size(I, I,
        typename dgboost::unordered::detail::disable_if_forward<I, void*>::type =
          0)
      {
        return 1;
      }
      ...
      inline std::size_t initial_size(I i, I j,
        std::size_t num_buckets =
          dgboost::unordered::detail::default_bucket_count)
      {
        return (std::max)(
          dgboost::unordered::detail::insert_size(i, j), num_buckets);
      }
      ...
      template <typename T, int Index> struct compressed_base : private T
      {
        ...
        compressed_base(T& x, move_tag) : T(dgboost::move(x)) {}
      ...
      template <typename T, int Index> struct uncompressed_base
      {
        ...
        uncompressed_base(T& x, move_tag) : value_(dgboost::move(x)) {}
      ...
      struct generate_base
        : dgboost::detail::if_true<
            dgboost::is_empty<T>::value>::BOOST_NESTED_TEMPLATE
            then<dgboost::unordered::detail::compressed_base<T, Index>,
              dgboost::unordered::detail::uncompressed_base<T, Index> >
      {
      };

      template <typename T1, typename T2>
      struct compressed
        : private dgboost::unordered::detail::generate_base<T1, 1>::type,
          private dgboost::unordered::detail::generate_base<T2, 2>::type
      {
        ...
        {
          first() = dgboost::move(x.first());
          second() = dgboost::move(x.second());
        }

        void swap(compressed& x)
        {
          dgboost::swap(first(), x.first());
          dgboost::swap(second(), x.second());
        }
...
// will be default-initialized.
      ...
      template <typename T>
      typename dgboost::add_lvalue_reference<T>::type make();
      struct choice9
      {
        typedef char (&type)[9];
      };
...
#define BOOST_UNORDERED_EMPLACE_FORWARD dgboost::forward<Args>(args)...
...
#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                                  \
  typedef typename dgboost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type       \
    BOOST_PP_CAT(Arg, n);                                                      \
  BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a)                                  \
  dgboost::forward<BOOST_PP_CAT(A, i)>(BOOST_PP_CAT(a, i))
...
// Uses the standard versions if available.
      ...
      typedef dgboost::unordered::detail::integral_constant<bool, true> true_type;
      typedef dgboost::unordered::detail::integral_constant<bool, false>
        false_type;
...
#pragma warning(pop)
      ...
      template <typename ValueType> struct value_base
      {
        ...
        typename dgboost::aligned_storage<sizeof(value_type),
          dgboost::alignment_of<value_type>::value>::type data_;
      ...
      template <typename T> class optional
      {
        ...
        dgboost::unordered::detail::value_base<T> value_;
        bool has_value_;

        void destroy()
        {
          if (has_value_) {
            dgboost::unordered::detail::func::destroy(value_.value_ptr());
            has_value_ = false;
          }
        }
        ...
        void move(optional<T>& x)
        {
          ...
          new (value_.value_ptr()) T(dgboost::move(x.value_.value()));
          dgboost::unordered::detail::func::destroy(x.value_.value_ptr());
          has_value_ = true;
          x.has_value_ = false;
        }
      ...
      public:
        ...
        void swap(optional<T>& x)
        {
          if (has_value_ != x.has_value_) {
            ...
            dgboost::swap(value_.value(), x.value_.value());
          }
        }
...
#define BOOST_UNORDERED_CHECK_EXPRESSION(count, result, expression)            \
  template <typename U>                                                        \
  static                                                                       \
    typename dgboost::unordered::detail::expr_test<BOOST_PP_CAT(choice, result), \
...
#define BOOST_UNORDERED_HAS_FUNCTION(name, thing, args, _)                     \
  ...
  {                                                                            \
    ...
    BOOST_UNORDERED_CHECK_EXPRESSION(                                          \
      1, 1, dgboost::unordered::detail::make<thing>().name args);                \
...
#define BOOST_UNORDERED_CHECK_MEMBER(count, result, name, member)              \
                                                                               \
  typedef                                                                      \
    typename dgboost::unordered::detail::identity<member>::type BOOST_PP_CAT(    \
      check, count);                                                           \
                                                                               \
  ...
  {                                                                            \
    ...
    {                                                                          \
      value = (1 == sizeof(test<Tp>(choose())))                                \
                                                                               ...
                                                                               \
    typedef typename dgboost::detail::if_true<value>::BOOST_NESTED_TEMPLATE      \
...
#define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                              \
  ...
  {                                                                            \
                                                                               \
    template <typename X>                                                      \
    static typename dgboost::unordered::detail::sfinae<typename X::tname,        \
...
#include <dgboost/limits.hpp>
#include <dgboost/pointer_to_other.hpp>
#include <dgboost/utility/enable_if.hpp>
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename Alloc, typename T> struct rebind_wrap
      {
        ...
        typedef
          typename dgboost::detail::if_true<value>::BOOST_NESTED_TEMPLATE then<
  ...
  namespace unordered {
    namespace detail {
      ...
      BOOST_UNORDERED_HAS_FUNCTION(construct, U,
        (dgboost::unordered::detail::make<ValueType*>(),
          dgboost::unordered::detail::make<Args const>()...),
        2);
      ...
      BOOST_UNORDERED_HAS_FUNCTION(construct, U,
        (dgboost::unordered::detail::make<ValueType*>(),
          dgboost::unordered::detail::make<ValueType const>()),
        2);
      ...
      template <typename T, typename ValueType>
      BOOST_UNORDERED_HAS_FUNCTION(
        destroy, U, (dgboost::unordered::detail::make<ValueType*>()), 1);
    ...
    namespace detail {
      namespace func {
        ...
        inline Alloc call_select_on_container_copy_construction(
          const Alloc& rhs,
          typename dgboost::enable_if_c<
            dgboost::unordered::detail::has_select_on_container_copy_construction<
              Alloc>::value,
            void*>::type = 0)
        {
        ...
        inline SizeType call_max_size(const Alloc& a,
          typename dgboost::enable_if_c<
            dgboost::unordered::detail::has_max_size<Alloc>::value, void*>::type =
            0)
        {
          return a.max_size();
        }
  ...
  namespace unordered {
    namespace detail {
      template <typename Alloc> struct allocator_traits
      {
        ...
        template <typename T>
        struct pointer_to_other : dgboost::pointer_to_other<pointer, T>
        {
        };
        ...
        template <typename T>
        using rebind_traits =
          dgboost::unordered::detail::allocator_traits<rebind_alloc<T> >;
#endif
      ...
      public:
        ...
        static
          typename dgboost::enable_if_c<dgboost::unordered::detail::has_construct<
            Alloc, T, Args...>::value>::type
          construct(Alloc& a, T* p, BOOST_FWD_REF(Args)... x)
        {
          a.construct(p, dgboost::forward<Args>(x)...);
        }

        template <typename T, typename... Args>
        static
          typename dgboost::disable_if_c<dgboost::unordered::detail::has_construct<
            Alloc, T, Args...>::value>::type
          construct(Alloc&, T* p, BOOST_FWD_REF(Args)... x)
        {
          new (static_cast<void*>(p)) T(dgboost::forward<Args>(x)...);
        }

        template <typename T>
        static typename dgboost::enable_if_c<
          dgboost::unordered::detail::has_destroy<Alloc, T>::value>::type
        destroy(Alloc& a, T* p)
        {
          a.destroy(p);
        }
        ...
        template <typename T>
        static typename dgboost::disable_if_c<
          dgboost::unordered::detail::has_destroy<Alloc, T>::value>::type
        destroy(Alloc&, T* p)
        {
          dgboost::unordered::detail::func::destroy(p);
        }
        ...
        template <typename T>
        static typename dgboost::enable_if_c<
          dgboost::unordered::detail::has_construct<Alloc, T>::value>::type
        ...
        static void construct(Alloc& a, T* p, T const& x,
          typename dgboost::enable_if_c<
            dgboost::unordered::detail::has_construct<Alloc, T>::value &&
              dgboost::is_same<T, value_type>::value,
            void*>::type = 0)
        {
          a.construct(p, x);
        }
        ...
        static void destroy(Alloc& a, T* p,
          typename dgboost::enable_if_c<
            dgboost::unordered::detail::has_destroy<Alloc, T>::value &&
              dgboost::is_same<T, value_type>::value,
            void*>::type = 0)
        {
          a.destroy(p);
        ...
        {
          return dgboost::unordered::detail::func::call_max_size<size_type>(a);
        }
        ...
        {
          return dgboost::unordered::detail::func::
        ...
        typedef BOOST_UNORDERED_DEFAULT_TYPE(Alloc, is_always_equal,
          typename dgboost::is_empty<Alloc>::type) is_always_equal;
      };
    }
  }
}
...
////////////////////////////////////////////////////////////////////////////////
//
// dgboost::container::allocator_traits

#elif BOOST_UNORDERED_USE_ALLOCATOR_TRAITS == 2

#include <dgboost/container/allocator_traits.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    namespace detail {
      ...
      template <typename Alloc>
      struct allocator_traits : dgboost::container::allocator_traits<Alloc>
      {
      };

      template <typename Alloc, typename T>
      struct rebind_wrap : dgboost::container::allocator_traits<
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(dgboost::forward<Args>(args)...);
        }
      }
    }
  }
...
#define BOOST_UNORDERED_CALL_CONSTRUCT1(Traits, alloc, address, a0)            \
  dgboost::unordered::detail::func::construct_value(address, a0)
#define BOOST_UNORDERED_CALL_DESTROY(Traits, alloc, x)                         \
  dgboost::unordered::detail::func::destroy(x)
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          new ((void*)address) T(dgboost::forward<A0>(a0));
        }
      }
    }
  }
...
// construct_from_tuple for dgboost::tuple
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    namespace detail {
      namespace func {
        template <typename Alloc, typename T>
        void construct_from_tuple(Alloc&, T* ptr, dgboost::tuple<>)
        {
          new ((void*)ptr) T();
        }
...
// construct_from_tuple for dgboost::tuple on old versions of sunpro.
//
// Old versions of Sun C++ had problems with template overloads of
// dgboost::tuple, so to fix it I added a distinct type for each length to
...
#define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(z, n, namespace_)                 \
  template <typename Alloc, typename T,                                        \
    BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
  void construct_from_tuple_impl(dgboost::unordered::detail::func::length<n>,    \
    Alloc&, T* ptr,                                                            \
    namespace_::tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)               \
  {                                                                            \
    new ((void*)ptr)                                                           \
    ...
    namespace detail {
      namespace func {
        ...
        void construct_from_tuple_impl(
          dgboost::unordered::detail::func::length<0>, Alloc&, T* ptr,
          dgboost::tuple<>)
        {
          new ((void*)ptr) T();
        }
        ...
        {
          construct_from_tuple_impl(dgboost::unordered::detail::func::length<
                                      dgboost::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
        }
      }
    }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        {
          static choice1::type test(
            choice1, dgboost::unordered::piecewise_construct_t);
          ...
          enum
          {
            value = sizeof(choice1::type) ==
                    sizeof(test(choose(), dgboost::unordered::detail::make<A0>()))
          };
        };
        ...
        {
          dgboost::unordered::detail::allocator_traits<Alloc>::construct(
            alloc, address, dgboost::forward<Args>(args)...);
        }

        // For backwards compatibility, implement a special case for
        // piecewise_construct with dgboost::tuple
        ...
        template <typename A0> struct detect_boost_tuple
        {
          ...
          static choice1::type test(choice1,
            dgboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> const&);
        ...
        inline typename dgboost::enable_if_c<use_piecewise<A0>::value &&
        ...
        {
          dgboost::unordered::detail::func::construct_from_tuple(
            alloc, dgboost::addressof(address->first), dgboost::forward<A1>(a1));
          BOOST_TRY
          {
            dgboost::unordered::detail::func::construct_from_tuple(
              alloc, dgboost::addressof(address->second), dgboost::forward<A2>(a2));
          }
          BOOST_CATCH(...)
          {
            dgboost::unordered::detail::func::destroy(
              dgboost::addressof(address->first));
            BOOST_RETHROW
          }
          BOOST_CATCH_END
        }
        ...
        {
          new ((void*)address) T(dgboost::forward<A0>(args.a0));
        }
        ...
        {
          new ((void*)address)
            T(dgboost::forward<A0>(args.a0), dgboost::forward<A1>(args.a1));
        }
        ...
        {
          new ((void*)address) T(dgboost::forward<A0>(args.a0),
            dgboost::forward<A1>(args.a1), dgboost::forward<A2>(args.a2));
        }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                       \
  ...
  inline void construct_from_args(Alloc&, T* address,                          \
    dgboost::unordered::detail::BOOST_PP_CAT(emplace_args, num_params) <         \
...
#undef BOOST_UNORDERED_CONSTRUCT_IMPL
        ...
        inline void construct_from_args(Alloc& alloc, std::pair<A, B>* address,
          dgboost::unordered::detail::emplace_args3<A0, A1, A2> const& args,
          typename enable_if<use_piecewise<A0>, void*>::type = 0)
        {
          dgboost::unordered::detail::func::construct_from_tuple(
            alloc, dgboost::addressof(address->first), args.a1);
          BOOST_TRY
          {
            dgboost::unordered::detail::func::construct_from_tuple(
              alloc, dgboost::addressof(address->second), args.a2);
          }
          BOOST_CATCH(...)
          {
            dgboost::unordered::detail::func::destroy(
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename NodeAlloc> struct node_constructor
      {
        ...
        typedef dgboost::unordered::detail::allocator_traits<NodeAlloc>
      ...
      {
        if (node_) {
          dgboost::unordered::detail::func::destroy(dgboost::to_address(node_));
      ...
      template <typename Alloc> void node_constructor<Alloc>::create_node()
      {
        ...
        new ((void*)dgboost::to_address(node_)) node();
      }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        inline
          typename dgboost::unordered::detail::allocator_traits<Alloc>::pointer
          ...
          construct_node(Alloc& alloc, BOOST_FWD_REF(U) x)
        {
          ...
          BOOST_UNORDERED_CALL_CONSTRUCT1(
            dgboost::unordered::detail::allocator_traits<Alloc>, alloc,
            a.node_->value_ptr(), dgboost::forward<U>(x));
          return a.release();
        }
          ...
          construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
          dgboost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(dgboost::forward<Key>(k)),
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_FWD_REF(Mapped) m)
        {
          ...
          dgboost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(dgboost::forward<Key>(k)),
            std::forward_as_tuple(dgboost::forward<Mapped>(m)));
          return a.release();
        }
      ...
      defined(BOOST_LIBSTDCXX11))
          dgboost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(dgboost::forward<Key>(k)),
            std::forward_as_tuple(dgboost::forward<Args>(args)...));
#else
          ...
          dgboost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            a.node_->value_ptr(), std::piecewise_construct,
            std::forward_as_tuple(dgboost::forward<Key>(k)),
            std::make_tuple(dgboost::forward<Args>(args)...));
#endif
          return a.release();
        }
          ...
          construct_node_pair(Alloc& alloc, BOOST_FWD_REF(Key) k)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
          dgboost::unordered::detail::func::construct_value(
            dgboost::addressof(a.node_->value_ptr()->first),
            dgboost::forward<Key>(k));
          BOOST_TRY
          {
            dgboost::unordered::detail::func::construct_value(
              dgboost::addressof(a.node_->value_ptr()->second));
          }
          BOOST_CATCH(...)
          {
            dgboost::unordered::detail::func::destroy(
            ...
            Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          BOOST_TRY
          {
            dgboost::unordered::detail::func::construct_from_args(alloc,
              dgboost::addressof(a.node_->value_ptr()->second),
  ...
  namespace unordered {
    namespace iterator_detail {
      ...
      template <typename Node> struct l_iterator
      {
        ...
        friend struct dgboost::unordered::iterator_detail::cl_iterator;
      ...
      template <typename Node> struct cl_iterator
      {
        friend struct dgboost::unordered::iterator_detail::l_iterator<Node>;
      ...
      public:
        ...
        cl_iterator(
          dgboost::unordered::iterator_detail::l_iterator<Node> const& x)
...
#if !defined(BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
        template <typename>
        friend struct dgboost::unordered::iterator_detail::c_iterator;
        template <typename> friend struct dgboost::unordered::detail::table;
      ...
      template <typename Node> struct c_iterator
      {
        friend struct dgboost::unordered::iterator_detail::iterator<Node>;
...
#endif
        typedef typename Node::node_pointer node_pointer;
        typedef dgboost::unordered::iterator_detail::iterator<Node> n_iterator;
        node_pointer node_;
    ...
    namespace detail {
      ...
      template <typename Alloc> node_holder<Alloc>::~node_holder()
      {
        while (nodes_) {
          ...
          dgboost::unordered::detail::func::destroy(dgboost::to_address(p));
      ...
      template <typename SizeT> struct prime_policy
      {
        ...
        {
          return dgboost::unordered::detail::next_prime(min);
        }

        static inline SizeT prev_bucket_count(SizeT max)
        {
          return dgboost::unordered::detail::prev_prime(max);
        }
      };
      ...
      template <> struct pick_policy2<dgboost::long_long_type>
      {
        typedef prime_policy<std::size_t> type;
      };

      template <> struct pick_policy2<dgboost::ulong_long_type>
      {
        typedef prime_policy<std::size_t> type;
      };
#endif
      ...
      template <typename T>
      struct pick_policy : pick_policy2<typename dgboost::remove_cv<T>::type>
      {
      };
      ...
      public:
        static const bool nothrow_move_assignable =
          dgboost::is_nothrow_move_assignable<H>::value &&
          dgboost::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
          dgboost::is_nothrow_move_constructible<H>::value &&
          dgboost::is_nothrow_move_constructible<P>::value;
        static const bool nothrow_swappable =
          dgboost::is_nothrow_swappable<H>::value &&
          dgboost::is_nothrow_swappable<P>::value;
      ...
      private:
        ...
        typedef typename dgboost::aligned_storage<sizeof(function_pair),
          dgboost::alignment_of<function_pair>::value>::type aligned_function;
      ...
      public:
        ...
        functions(functions& bf, dgboost::unordered::detail::move_tag)
            : current_(0)
        {
          construct_functions(current_, bf.current_functions(),
            dgboost::unordered::detail::integral_constant<bool,
      ...
      private:
        ...
        void construct_functions(unsigned char which, function_pair const& f,
          dgboost::unordered::detail::false_type =
            dgboost::unordered::detail::false_type())
        {
          BOOST_ASSERT(!(which & 2));
        ...
        void construct_functions(unsigned char which, function_pair& f,
          dgboost::unordered::detail::true_type)
        {
          BOOST_ASSERT(!(which & 2));
          new ((void*)&funcs_[which])
            function_pair(f, dgboost::unordered::detail::move_tag());
        }
...
#define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
      ...
      template <typename T>
      struct rv_ref
        : dgboost::detail::if_true<dgboost::is_class<T>::value>::
            BOOST_NESTED_TEMPLATE then<dgboost::unordered::detail::rv_ref_impl<T>,
              please_ignore_this_overload>::type
      {
      };

#define BOOST_UNORDERED_RV_REF(T)                                              \
  typename dgboost::unordered::detail::rv_ref<T>::type
#endif
...
#pragma warning(disable : 4127) // conditional expression is constant
      ...
      struct table : dgboost::unordered::detail::functions<typename Types::hasher,
      ...
      public:
        ...
        typedef dgboost::unordered::detail::functions<typename Types::hasher,
          typename Types::key_equal>
          functions;

        typedef typename Types::value_allocator value_allocator;
        typedef typename dgboost::unordered::detail::rebind_wrap<value_allocator,
          node>::type node_allocator;
        typedef typename dgboost::unordered::detail::rebind_wrap<value_allocator,
          bucket>::type bucket_allocator;
        typedef dgboost::unordered::detail::allocator_traits<node_allocator>
          node_allocator_traits;
        typedef dgboost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef dgboost::unordered::detail::node_constructor<node_allocator>
          node_constructor;
        typedef dgboost::unordered::detail::node_tmp<node_allocator> node_tmp;
        ...
        dgboost::unordered::detail::compressed<bucket_allocator, node_allocator>
          allocators_;
        std::size_t bucket_count_;
        std::size_t size_;
        float mlf_;
        ...
        void recalculate_max_load()
        {
          ...
          max_load_ = buckets_ ? dgboost::unordered::detail::double_to_size(
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
          ...
          return policy::new_bucket_count(
            dgboost::unordered::detail::double_to_size(
        ...
        table(table& x, dgboost::unordered::detail::move_tag m)
        ...
        table(table& x, node_allocator const& a,
          dgboost::unordered::detail::move_tag m)
        ...
        void create_buckets(std::size_t new_count)
        {
          ...
          for (bucket_pointer i = buckets_; i != end; ++i) {
            new ((void*)dgboost::to_address(i)) bucket();
          }
          new ((void*)dgboost::to_address(end)) bucket(dummy_node);
        }
        ...
        {
          dgboost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x, false_type)
        {
          ...
          swap_allocators(
            x, dgboost::unordered::detail::integral_constant<bool,
                 allocator_traits<
                   node_allocator>::propagate_on_container_swap::value>());

          dgboost::swap(buckets_, x.buckets_);
          dgboost::swap(bucket_count_, x.bucket_count_);
          dgboost::swap(size_, x.size_);
        ...
        void swap(table& x)
        {
          ...
          swap(x, dgboost::unordered::detail::integral_constant<bool,
        ...
        void move_construct_buckets(table& src)
        {
          if (this->node_alloc() == src.node_alloc()) {
            ...
            for (node_pointer n = src.begin(); n; n = next_node(n)) {
              ...
              node_pointer n2 = dgboost::unordered::detail::func::construct_node(
                this->node_alloc(), dgboost::move(n->value()));
        ...
        void destroy_node(node_pointer n)
        {
          ...
          dgboost::unordered::detail::func::destroy(dgboost::to_address(n));
        ...
        void destroy_buckets()
        {
          ...
          for (bucket_pointer it = buckets_; it != end; ++it) {
            dgboost::unordered::detail::func::destroy(dgboost::to_address(it));
          }
          ...
          if (pos) {
            ...
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
                dgboost::unordered::detail::func::construct_node_from_args(
        ...
        {
          node_tmp b(dgboost::unordered::detail::func::construct_node_from_args(
                       this->node_alloc(), BOOST_UNORDERED_EMPLACE_FORWARD),
            this->node_alloc());
        ...
        emplace_return try_emplace_unique(BOOST_FWD_REF(Key) k)
        {
          ...
          if (pos) {
            ...
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
                dgboost::unordered::detail::func::construct_node_pair(
                  this->node_alloc(), dgboost::forward<Key>(k)),
                key_hash)),
              true);
          }
        }
          ...
          BOOST_FWD_REF(Key) k, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          ...
          if (pos) {
            ...
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
                dgboost::unordered::detail::func::construct_node_pair_from_args(
                  this->node_alloc(), dgboost::forward<Key>(k),
                  BOOST_UNORDERED_EMPLACE_FORWARD),
                key_hash)),
              true);
          ...
          BOOST_FWD_REF(Key) k, BOOST_FWD_REF(M) obj)
        {
          ...
          if (pos) {
            pos->value().second = dgboost::forward<M>(obj);
            return emplace_return(iterator(pos), false);
          } else {
            return emplace_return(
              iterator(this->resize_and_add_node_unique(
        ...
        void merge_unique(dgboost::unordered::detail::table<Types2>& other)
        {
          typedef dgboost::unordered::detail::table<Types2> other_table;
          BOOST_STATIC_ASSERT(
            (dgboost::is_same<node, typename other_table::node>::value));
        ...
        void insert_range_unique2(const_key_type& k, InputIt i, InputIt j)
        {
          ...
          if (!pos) {
            node_tmp b(dgboost::unordered::detail::func::construct_node(
                         this->node_alloc(), *i),
              this->node_alloc());
            if (this->size_ + 1 > this->max_load_)
              this->reserve_for_insert(
                this->size_ + dgboost::unordered::detail::insert_size(i, j));
        ...
        void copy_buckets(table const& src, true_type)
        {
          ...
          for (node_pointer n = src.begin(); n; n = next_node(n)) {
            ...
            this->add_node_unique(
              dgboost::unordered::detail::func::construct_node(
            ...
            0)
        {
          ...
          if (distance == 1) {
            emplace_equiv(dgboost::unordered::detail::func::construct_node(
              this->node_alloc(), *i));
          } else {
        ...
        template <class I>
        void insert_range_equiv(I i, I j,
          typename dgboost::unordered::detail::disable_if_forward<I,
            void*>::type = 0)
        {
          for (; i != j; ++i) {
            emplace_equiv(dgboost::unordered::detail::func::construct_node(
...
#pragma warning(pop)
      ...
      template <typename Key, typename T> struct is_key
      {
        ...
        enum
        {
          value = sizeof(test(dgboost::unordered::detail::make<T>())) ==
                  sizeof(choice2::type)
        };
      ...
      {
        typedef ValueType value_type;
        typedef typename dgboost::remove_const<typename dgboost::unordered::detail::
        ...
        template <class Second>
        static key_type const& extract(
          dgboost::rv<std::pair<key_type, Second> > const& v)
        {
          return v.first;
        }
        ...
        template <class Second>
        static key_type const& extract(
          dgboost::rv<std::pair<key_type const, Second> > const& v)
        {
          return v.first;
        }
#endif
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  ...
  static no_key extract(dgboost::unordered::piecewise_construct_t,               \
  ...
  static typename is_key<key_type, T>::type extract(                           \
    dgboost::unordered::piecewise_construct_t, namespace_ tuple<T> const& k,     \
    T2 const&)                                                                 \
  {                                                                            \
...
#define BOOST_UNORDERED_KEY_FROM_TUPLE(namespace_)                             \
  static no_key extract(                                                       \
    dgboost::unordered::piecewise_construct_t, namespace_ tuple<> const&)        \
  {                                                                            \
    return no_key();                                                           \
  }                                                                            \
                                                                               \
  ...
  {                                                                            \
    return typename is_key<key_type, T>::type(namespace_ get<0>(k));           \
        ...
        BOOST_UNORDERED_KEY_FROM_TUPLE(dgboost::)
...
#undef BOOST_UNORDERED_KEY_FROM_TUPLE
      ...
      struct node : dgboost::unordered::detail::value_base<T>
      {
        typedef
          typename ::dgboost::unordered::detail::rebind_wrap<A, node<A, T> >::type
            allocator;
        typedef typename ::dgboost::unordered::detail::allocator_traits<
          allocator>::pointer node_pointer;
        typedef node_pointer link_pointer;
        typedef typename ::dgboost::unordered::detail::rebind_wrap<A,
      ...
      template <typename T>
      struct ptr_node : dgboost::unordered::detail::ptr_bucket
      {
        typedef T value_type;
        typedef dgboost::unordered::detail::ptr_bucket bucket_base;
        typedef ptr_node<T>* node_pointer;
        typedef ptr_bucket* link_pointer;
        typedef ptr_bucket* bucket_pointer;

        std::size_t bucket_info_;
        dgboost::unordered::detail::value_base<T> value_base_;
      ...
      struct pick_node2
      {
        typedef dgboost::unordered::detail::node<A, T> node;

        typedef typename dgboost::unordered::detail::allocator_traits<
          typename dgboost::unordered::detail::rebind_wrap<A,
            node>::type>::pointer node_pointer;

        typedef dgboost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
      };

      template <typename A, typename T>
      struct pick_node2<A, T, dgboost::unordered::detail::ptr_node<T>*,
        dgboost::unordered::detail::ptr_bucket*>
      {
        typedef dgboost::unordered::detail::ptr_node<T> node;
        typedef dgboost::unordered::detail::ptr_bucket bucket;
        typedef bucket* link_pointer;
      };

      template <typename A, typename T> struct pick_node
      {
        typedef typename dgboost::remove_const<T>::type nonconst;

        typedef dgboost::unordered::detail::allocator_traits<
          typename dgboost::unordered::detail::rebind_wrap<A,
            dgboost::unordered::detail::ptr_node<nonconst> >::type>
          tentative_node_traits;

        typedef dgboost::unordered::detail::allocator_traits<
          typename dgboost::unordered::detail::rebind_wrap<A,
            dgboost::unordered::detail::ptr_bucket>::type>
