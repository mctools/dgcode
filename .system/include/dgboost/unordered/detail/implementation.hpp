...
#include <dgboost/core/allocator_traits.hpp>
#include <dgboost/core/bit.hpp>
...
#include <dgboost/unordered/detail/fca.hpp>
...
#include <dgboost/mp11/algorithm.hpp>
#endif
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    namespace detail {
      ...
      template <class I>
      inline typename dgboost::unordered::detail::enable_if_forward<I,
        std::size_t>::type
      insert_size(I i, I j)
      {
      ...
      template <class I>
      inline typename dgboost::unordered::detail::disable_if_forward<I,
      ...
      struct compressed_base : dgboost::empty_value<T>
      {
        compressed_base(T const& x) : empty_value<T>(dgboost::empty_init_t(), x)
        {
        }
        compressed_base(T& x, move_tag)
            : empty_value<T>(dgboost::empty_init_t(), dgboost::move(x))
        {
        }
      ...
      template <typename T, int Index>
      struct generate_base : dgboost::unordered::detail::compressed_base<T, Index>
      {
...
// Type checkers used for the transparent member functions added by C++20 and up
      ...
      struct is_transparent<T,
        typename dgboost::make_void<typename T::is_transparent>::type>
          : public true_type
      {
      };
      ...
      template <class Key, class UnorderedMap> struct transparent_non_iterable
      {
        ...
        static bool const value =
          ...
          !dgboost::is_convertible<Key, iterator>::value &&
          !dgboost::is_convertible<Key, const_iterator>::value;
      };
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    namespace detail {
      ...
      struct allocator_traits : dgboost::allocator_traits<Alloc>
      {
      };

      template <typename Alloc, typename T>
      struct rebind_wrap : dgboost::allocator_rebind<Alloc, T>
      {
      };
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 1, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 2, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 3, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 4, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 5, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 6, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 7, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 8, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 9, dgboost)
        BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(1, 10, dgboost)
      }
    }
  }
}
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        to_std_tuple_impl(dgboost::mp11::mp_list<Args...>,
          dgboost::tuple<TupleArgs...>& tuple, dgboost::mp11::index_sequence<Is...>)
        {
          (void) tuple;
          return std::tuple<typename std::add_lvalue_reference<Args>::type...>(
            dgboost::get<Is>(tuple)...);
        }
        ...
        template <class... Args>
        dgboost::mp11::mp_transform<add_lvalue_reference_t,
          dgboost::mp11::mp_remove<std::tuple<Args...>,
            dgboost::tuples::null_type> >
        to_std_tuple(dgboost::tuple<Args...>& tuple)
        {
          using list = dgboost::mp11::mp_remove<dgboost::mp11::mp_list<Args...>,
            dgboost::tuples::null_type>;
          using list_size = dgboost::mp11::mp_size<list>;
          using index_seq = dgboost::mp11::make_index_sequence<list_size::value>;
        ...
        {
          dgboost::allocator_construct(alloc, address, std::piecewise_construct,
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  namespace unordered {
    namespace detail {
      ...
      {
        typedef typename dgboost::allocator_value_type<NodeAlloc>::type node;
        typedef typename dgboost::allocator_pointer<NodeAlloc>::type node_pointer;
        typedef typename node::value_type value_type;
        typedef typename dgboost::allocator_rebind<NodeAlloc, value_type>::type
          value_allocator;
      ...
      template <typename Alloc> node_tmp<Alloc>::~node_tmp()
      {
        if (node_) {
          ...
          dgboost::allocator_destroy(val_alloc, node_->value_ptr());
          dgboost::allocator_deallocate(alloc_, node_, 1);
        }
      }
    }
  }
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        inline typename dgboost::allocator_pointer<Alloc>::type
        construct_node_from_args(Alloc& alloc, BOOST_UNORDERED_EMPLACE_ARGS)
        {
          typedef typename dgboost::allocator_value_type<Alloc>::type node;
          typedef typename node::value_type value_type;
          typedef typename dgboost::allocator_rebind<Alloc, value_type>::type
            value_allocator;
        ...
        inline typename dgboost::allocator_pointer<Alloc>::type construct_node(
          Alloc& alloc, BOOST_FWD_REF(U) x)
        {
          ...
          dgboost::allocator_construct(
            val_alloc, a.node_->value_ptr(), dgboost::forward<U>(x));
          return a.release();
        }
          ...
          Alloc& alloc, BOOST_FWD_REF(Key) k, BOOST_FWD_REF(Mapped) m)
        {
          ...
          dgboost::allocator_construct(val_alloc, a.node_->value_ptr(),
  ...
  namespace unordered {
    namespace detail {
      ...
      public:
        ...
        {
          return *::dgboost::unordered::detail::launder(
...
#define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
      ...
      template <typename T>
      struct rv_ref : dgboost::conditional<dgboost::is_class<T>::value,
                        dgboost::unordered::detail::rv_ref_impl<T>,
...
#pragma warning(disable : 4127) // conditional expression is constant
      ...
      namespace iterator_detail {
        ...
        public:
          ...
          {
            pointer x = dgboost::addressof(p->value());
            return x;
          }
          ...
          bool operator==(
            dgboost::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        private:
          ...
          template <class Types> friend struct dgboost::unordered::detail::table;
          ...
          bool equal(
            const dgboost::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        public:
          ...
          bool operator==(
            dgboost::unordered::detail::iterator_detail::iterator<Node,
              Bucket> const& other) const BOOST_NOEXCEPT
          {
            return equal(other);
          }
      ...
      public:
        ...
        typedef typename dgboost::allocator_void_pointer<value_allocator>::type void_pointer;
        typedef node<value_type, void_pointer> node_type;

        typedef dgboost::unordered::detail::grouped_bucket_array<
          bucket<node_type, void_pointer>, value_allocator, prime_fmod_size<> >
          bucket_array_type;

        typedef typename bucket_array_type::node_allocator_type
          node_allocator_type;
        typedef typename dgboost::allocator_pointer<node_allocator_type>::type node_pointer;

        typedef dgboost::unordered::detail::node_constructor<node_allocator_type>
          node_constructor;
        typedef dgboost::unordered::detail::node_tmp<node_allocator_type> node_tmp;
      ...
      public:
        ...
        std::size_t max_bucket_count() const
        {
          ...
          return size_policy::size(size_policy::size_index(
            dgboost::allocator_max_size(this->node_alloc())));
        }
        ...
        void recalculate_max_load()
        {
          ...
          max_load_ = dgboost::unordered::detail::double_to_size(
        ...
        table(table& x, dgboost::unordered::detail::move_tag m)
            : functions(x, m), size_(x.size_), mlf_(x.mlf_),
              max_load_(x.max_load_), buckets_(dgboost::move(x.buckets_))
        {
          x.size_ = 0;
          x.max_load_ = 0;
        }
        ...
        void swap(table& x)
        {
          BOOST_ASSERT(dgboost::allocator_propagate_on_container_swap<
        ...
        {
          buckets_ = dgboost::move(other.buckets_);
        ...
        void move_construct_buckets(table& src)
        {
          ...
          for (iterator pos = src.begin(); pos != src.end(); ++pos) {
            node_tmp b(detail::func::construct_node(
                         this->node_alloc(), dgboost::move(pos.p->value())),
              this->node_alloc());
        ...
        void delete_node(node_pointer p)
        {
          ...
          value_allocator val_alloc(alloc);
          dgboost::allocator_destroy(val_alloc, p->value_ptr());
          dgboost::allocator_deallocate(alloc, p, 1);
        }
        ...
        {
          typedef typename dgboost::allocator_propagate_on_container_copy_assignment<node_allocator_type>::type pocca;
        ...
        void assign(table const &x, UniqueType is_unique, true_type)
        {
          ...
          else
          {
            ...
            delete_buckets();
            buckets_.reset_allocator(x.node_alloc());
            buckets_ = dgboost::move(new_buckets);
        ...
        void move_assign(table& x, UniqueType is_unique)
        {
          if (this != &x) {
            move_assign(x, is_unique,
              dgboost::unordered::detail::integral_constant<bool,
                dgboost::allocator_propagate_on_container_move_assignment<
                  node_allocator_type>::type::value>());
          }
        }
        ...
        node_pointer* find_prev(Key const& key, bucket_iterator itb)
        {
          ...
          for (node_pointer* pp = dgboost::addressof(itb->next); *pp;
               pp = dgboost::addressof((*pp)->next)) {
        ...
        emplace_return try_emplace_unique(BOOST_FWD_REF(Key) k)
        {
          ...
          if (pos) {
            ...
            node_tmp tmp(
              detail::func::construct_node_pair(alloc, dgboost::forward<Key>(k)),
              alloc);
          ...
          BOOST_FWD_REF(Key) k, BOOST_FWD_REF(M) obj)
        {
          ...
          node_pointer p = this->find_node_impl(k, itb);
          if (p) {
            p->value().second = dgboost::forward<M>(obj);
            return emplace_return(iterator(p, itb), false);
          }

          node_tmp b(dgboost::unordered::detail::func::construct_node_pair(
        ...
        void merge_unique(dgboost::unordered::detail::table<Types2>& other)
        {
          ...
          BOOST_STATIC_ASSERT((dgboost::is_same<node_type,
        ...
        iterator erase_node(c_iterator pos) {
          ...
          bucket_iterator itb = pos.itb;
          node_pointer* pp = dgboost::addressof(itb->next);
          while (*pp != pos.p) {
            pp = dgboost::addressof((*pp)->next);
          }
        ...
        void move_assign_buckets(table& src, true_type)
        {
          ...
          for (iterator pos = src.begin(); pos != last; ++pos) {
            value_type value = dgboost::move(*pos);
            const_key_type& key = extractor::extract(value);
            std::size_t const key_hash = this->hash(key);
            ...
            node_tmp tmp(
              detail::func::construct_node(alloc, dgboost::move(value)), alloc);
      ...
      inline void table<Types>::rehash_impl(std::size_t num_buckets)
      {
        ...
        BOOST_TRY
        {
          dgboost::unordered::detail::span<bucket_type> bspan = buckets_.raw();
...
#pragma warning(pop)
      ...
      template <typename Key, typename T> struct is_key
      {
        ...
        typedef
          typename dgboost::conditional<value, Key const&, no_key>::type type;
      };
