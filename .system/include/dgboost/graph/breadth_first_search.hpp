    ...
    namespace detail {
      ...
      struct breadth_first_search_impl {
        ...
        void operator()(const Graph& g, const Source& source, const ArgPack& arg_pack) {
          ...
          typename dgboost::graph_traits<Graph>::vertex_descriptor sources[1] = {source};
          dgboost::queue<typename dgboost::graph_traits<Graph>::vertex_descriptor> Q;
          dgboost::breadth_first_search(g,
                                      &sources[0],
                                      &sources[1], 
