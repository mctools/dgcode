...
namespace std {
  ...
  operator<<(std::basic_ostream<Char, Traits>& os,
             const dgboost::detail::edge_desc_impl<D,V>& e)
  {
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  ...
  struct hash<dgboost::detail::edge_desc_impl<D, V> >
  {
    std::size_t operator()(const dgboost::detail::edge_desc_impl<D, V> & x) const
