...
#include <dgboost/shared_array.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  ...
  inline void property_map_swap(
         PropMap prop_map,
         const typename dgboost::property_traits<PropMap>::key_type& ka, 
         const typename dgboost::property_traits<PropMap>::key_type& kb) {
    typename dgboost::property_traits<PropMap>::value_type va = get(prop_map, ka);
  ...
  namespace detail {
    ...
    class fixed_max_size_vector {
      dgboost::shared_array<Value> m_data;
      std::size_t m_size;
  ...
  class d_ary_heap_indirect {
    ...
    typedef typename dgboost::property_traits<DistanceMap>::value_type key_type;
    ...
    // distance map
    typedef typename dgboost::property_traits<DistanceMap>::value_type distance_type;
