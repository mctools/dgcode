...
BOOST_concept(IncidenceGraph, (G)) : Graph< G >
{
    ...
    BOOST_STATIC_ASSERT(
        (dgboost::mpl::not_< dgboost::is_same< out_edge_iterator, void > >::value));
    BOOST_STATIC_ASSERT(
        (dgboost::mpl::not_< dgboost::is_same< degree_size_type, void > >::value));
...
BOOST_concept(BidirectionalGraph, (G)) : IncidenceGraph< G >
{
    ...
    BOOST_CONCEPT_USAGE(BidirectionalGraph)
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<
            dgboost::is_same< in_edge_iterator, void > >::value));
...
BOOST_concept(AdjacencyGraph, (G)) : Graph< G >
{
    ...
    BOOST_CONCEPT_USAGE(AdjacencyGraph)
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<
            dgboost::is_same< adjacency_iterator, void > >::value));
...
BOOST_concept(VertexListGraph, (G)) : Graph< G >
{
    ...
    BOOST_CONCEPT_USAGE(VertexListGraph)
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<
            dgboost::is_same< vertex_iterator, void > >::value));
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<
            dgboost::is_same< vertices_size_type, void > >::value));
...
BOOST_concept(EdgeListGraph, (G)) : Graph< G >
{
    ...
    BOOST_CONCEPT_USAGE(EdgeListGraph)
    {
        ...
        BOOST_STATIC_ASSERT(
            (dgboost::mpl::not_< dgboost::is_same< edge_iterator, void > >::value));
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<
            dgboost::is_same< edges_size_type, void > >::value));
