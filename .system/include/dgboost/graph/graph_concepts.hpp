...
#include <dgboost/graph/numeric_values.hpp>
#include <dgboost/graph/buffer_concepts.hpp>
...
//
// It is needed in order to allow us to write using dgboost::vertices as
...
typename T::ThereReallyIsNoMemberByThisNameInT vertices(T const&);
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<out_edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<degree_size_type, void> >::value));
        ...
        : IncidenceGraph<G>
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<in_edge_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<adjacency_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<vertex_iterator, void> >::value));
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<vertices_size_type, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((dgboost::mpl::not_<dgboost::is_same<edges_size_type, void> >::value));
        ...
        : MutableGraph<G>
    {
        ...
        typename dgboost::graph_traits<G>::vertex_descriptor u;
        typename dgboost::graph_traits<G>::out_edge_iterator iter;
    };
...
using dgboost::concepts::MultiPassInputIteratorConcept;

// Graph concepts
using dgboost::concepts::GraphConcept;
using dgboost::concepts::IncidenceGraphConcept;
using dgboost::concepts::BidirectionalGraphConcept;
using dgboost::concepts::AdjacencyGraphConcept;
using dgboost::concepts::VertexListGraphConcept;
using dgboost::concepts::EdgeListGraphConcept;
using dgboost::concepts::VertexAndEdgeListGraphConcept;
using dgboost::concepts::EdgeMutableGraphConcept;
using dgboost::concepts::VertexMutableGraphConcept;
using dgboost::concepts::MutableGraphConcept;
using dgboost::concepts::MutableIncidenceGraphConcept;
using dgboost::concepts::MutableBidirectionalGraphConcept;
using dgboost::concepts::MutableEdgeListGraphConcept;
using dgboost::concepts::VertexMutablePropertyGraphConcept;
using dgboost::concepts::EdgeMutablePropertyGraphConcept;
using dgboost::concepts::AdjacencyMatrixConcept;
using dgboost::concepts::ReadablePropertyGraphConcept;
using dgboost::concepts::PropertyGraphConcept;
using dgboost::concepts::LvaluePropertyGraphConcept;
using dgboost::concepts::VertexIndexGraphConcept;
using dgboost::concepts::EdgeIndexGraphConcept;

// Utility concepts
using dgboost::concepts::ColorValueConcept;
using dgboost::concepts::BasicMatrixConcept;
using dgboost::concepts::NumericValueConcept;
using dgboost::concepts::DistanceMeasureConcept;
using dgboost::concepts::DegreeMeasureConcept;
