...
{
    typedef
        typename dgboost::vertex_property_type< BidirectionalGraph >::type type;
};
...
{
    typedef
        typename dgboost::graph_property_type< BidirectionalGraph >::type type;
};
...
{
    typedef dgboost::is_same<
        typename detail::property_kind_from_graph< BidirGraph, Property >::type,
        edge_property_tag >
        is_edge_prop;
    typedef dgboost::is_const< typename dgboost::remove_reference< GRef >::type >
        is_ref_const;
    typedef typename dgboost::mpl::if_< is_ref_const,
    ...
    typedef typename property_map< BidirGraph, Property >::const_type
        orig_const_type;
    typedef typename dgboost::mpl::if_< is_edge_prop,
...
struct is_reverse_graph< reverse_graph< G, R > > : dgboost::mpl::true_
{
};
...
template < typename BidirectionalGraph, typename GRef, typename Tag >
inline typename dgboost::mpl::if_<
