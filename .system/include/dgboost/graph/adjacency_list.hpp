...
#include <dgboost/scoped_ptr.hpp>

#include <dgboost/graph/graph_traits.hpp>
#include <dgboost/graph/graph_mutability_traits.hpp>
#include <dgboost/graph/graph_selectors.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost {
  ...
  struct container_gen<hash_setS, ValueType> {
    typedef dgboost::unordered_set<ValueType> type;
  };
  ...
  struct container_gen<hash_multisetS, ValueType> {
    typedef dgboost::unordered_multiset<ValueType> type;
  };
...
#include <dgboost/graph/detail/adjacency_list.hpp>
