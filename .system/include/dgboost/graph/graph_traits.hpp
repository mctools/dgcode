...
#define BOOST_GRAPH_MEMBER_OR_VOID(name)                                                                                            \
    ...
    : dgboost::mpl::eval_if_c< BOOST_JOIN(has_, name) < T >::value, BOOST_JOIN(get_member_, name)< T >, dgboost::mpl::identity< void > >\
    {                                                                                                                               \
    };
...
typedef dgboost::forward_traversal_tag multi_pass_input_iterator_tag;
...
: dgboost::mpl::eval_if< detail::has_graph_property_type< G >,
      detail::get_graph_property_type< G >, no_property >
{
};
template < typename G >
struct edge_property_type
: dgboost::mpl::eval_if< detail::has_edge_property_type< G >,
      detail::get_edge_property_type< G >, no_property >
{
};
template < typename G >
struct vertex_property_type
: dgboost::mpl::eval_if< detail::has_vertex_property_type< G >,
