...
namespace graph_detail
{
    ...
    struct container_traits<
        dgboost::unordered_multimap< Key, T, Eq, Hash, Alloc > >
    {
    ...
    unordered_set_tag container_category(
        const dgboost::unordered_set< Key, Eq, Hash, Alloc >&)
    {
    ...
    unordered_map_tag container_category(
        const dgboost::unordered_map< Key, T, Eq, Hash, Alloc >&)
    {
    ...
    unordered_multiset_tag container_category(
        const dgboost::unordered_multiset< Key, Eq, Hash, Alloc >&)
    {
    ...
    unordered_multimap_tag container_category(
        const dgboost::unordered_multimap< Key, T, Eq, Hash, Alloc >&)
    {
