...
struct lookup_one_property_internal< dgboost::property< Tag, T, Base >, PropName >
...
public:
    ...
    static
        typename lazy_enable_if< is_same< PL, dgboost::property< Tag, T, Base > >,
            add_reference< typename base_type::type > >::type
...
template < class P > struct has_property : dgboost::mpl::true_
{
};
template <> struct has_property< no_property > : dgboost::mpl::false_
{
};
...
namespace detail
{
    ...
    struct remove_first_property
    {
        template < typename F > struct result
        {
            ...
            typedef typename dgboost::mpl::if_< dgboost::is_const< non_ref >,
                dgboost::add_const< nx >, nx >::type with_const;
