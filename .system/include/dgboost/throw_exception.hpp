...
#endif
# define BOOST_THROW_EXCEPTION(x) ::dgboost::exception_detail::throw_exception_(x,BOOST_THROW_EXCEPTION_CURRENT_FUNCTION,__FILE__,__LINE__)
#else
# define BOOST_THROW_EXCEPTION(x) ::dgboost::throw_exception(x)
#endif
