...
#   include <dgboost/mpl/limits/vector.hpp>
...
#   include BOOST_PP_STRINGIZE(dgboost/mpl/vector/AUX778076_VECTOR_C_HEADER)
...
#   include <dgboost/mpl/aux_/sequence_wrapper.hpp>
