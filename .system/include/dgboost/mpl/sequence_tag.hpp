...
#include <dgboost/mpl/sequence_tag_fwd.hpp>
#include <dgboost/mpl/aux_/has_tag.hpp>
#include <dgboost/mpl/aux_/has_begin.hpp>
#include <dgboost/mpl/aux_/na_spec.hpp>
#include <dgboost/mpl/aux_/is_msvc_eti_arg.hpp>
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::dgboost::mpl::aux::has_tag<Sequence>::value
        , ::dgboost::mpl::aux::has_begin<Sequence>::value
