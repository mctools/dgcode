...
#   include <dgboost/mpl/aux_/arity.hpp>
#   include <dgboost/mpl/aux_/has_apply.hpp>
#   include <dgboost/mpl/aux_/na.hpp>
#   include <dgboost/mpl/aux_/msvc_never_true.hpp>
#endif
...
#   include <dgboost/mpl/aux_/config/bcc.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <dgboost/mpl/apply_wrap.hpp>))
...
#include <dgboost/mpl/aux_/msvc_dtw.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_2 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY - i_, <dgboost/mpl/apply_wrap.hpp>))
#include BOOST_PP_ITERATE()
...
struct BOOST_PP_CAT(apply_wrap,i_)
    : BOOST_PP_CAT(apply_wrap_impl,i_)<
          ::dgboost::mpl::aux::arity<F,i_>::value
        , F
