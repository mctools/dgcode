...
#   include <dgboost/mpl/aux_/na_fwd.hpp>
...
#   include <dgboost/preprocessor/list/for_each_i.hpp>
...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::dgboost::mpl::aux::yes_tag operator|( \
      ::dgboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::dgboost::mpl::aux::no_tag operator|( \
      ::dgboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::dgboost::mpl::na) >* \
    ); \
/**/
...
::dgboost::mpl::aux::yes_tag operator|( \
      ::dgboost::mpl::aux::has_rebind_tag<int> \
    , ::dgboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
