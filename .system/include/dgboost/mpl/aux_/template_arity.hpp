...
#   include <dgboost/mpl/aux_/template_arity_fwd.hpp>
...
#   endif
#   else
#       include <dgboost/mpl/aux_/has_rebind.hpp>
#   endif
#endif
...
#   include <dgboost/mpl/aux_/preprocessor/range.hpp>
...
#   include <dgboost/preprocessor/seq/fold_left.hpp>
...
#   define BOOST_PP_FILENAME_1 <dgboost/mpl/aux_/template_arity.hpp>
...
{
    BOOST_STATIC_CONSTANT(int, value = 
          sizeof(::dgboost::mpl::aux::arity_helper(type_wrapper<F>(),arity_tag<N>())) - 1
        );
};
...
template< typename F >
struct template_arity
    : template_arity_impl< ::dgboost::mpl::aux::has_rebind<F>::value >
        ::template result_<F>
{
};
