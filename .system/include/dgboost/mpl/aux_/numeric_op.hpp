...
#   include <dgboost/mpl/aux_/preprocessor/sub.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( BOOST_PP_DEC(AUX778076_OP_ARITY), 2, <dgboost/mpl/aux_/numeric_op.hpp> ))
