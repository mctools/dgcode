...
#include <dgboost/mpl/next_prior.hpp>
...
#include <dgboost/mpl/aux_/unwrap.hpp>

#include <dgboost/type_traits/is_same.hpp>
#include <dgboost/utility/value_init.hpp>
...
struct for_each_impl<false>
{
        ...
        )
    {
        ...
        aux::unwrap(f, 0)(dgboost::get(x));
        
        typedef typename mpl::next<Iterator>::type iter;
        for_each_impl<dgboost::is_same<iter,LastIterator>::value>
...
void for_each(F f, Sequence* = 0, TransformOp* = 0)
{
    ...
    aux::for_each_impl< dgboost::is_same<first,last>::value >
...
{
  // jfalcou: fully qualifying this call so it doesnt clash with dgboostphoenix::for_each
  // ons ome compilers -- done on 02/28/2011
  dgboost::mpl::for_each<Sequence, identity<> >(f);
}
