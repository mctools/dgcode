...
#include <dgboost/mpl/aux_/nested_type_wknd.hpp>
#include <dgboost/mpl/aux_/yes_no.hpp>
#include <dgboost/mpl/aux_/na.hpp>
#include <dgboost/mpl/aux_/adl_barrier.hpp>

#include <dgboost/mpl/aux_/config/nttp.hpp>
#include <dgboost/mpl/aux_/config/dtp.hpp>
#include <dgboost/mpl/aux_/config/gcc.hpp>
#include <dgboost/mpl/aux_/config/msvc.hpp>
#include <dgboost/mpl/aux_/config/gpu.hpp>
#include <dgboost/mpl/aux_/config/static_constant.hpp>
#include <dgboost/mpl/aux_/config/pp_counter.hpp>
#include <dgboost/mpl/aux_/config/workaround.hpp>

#include <dgboost/preprocessor/cat.hpp>

#include <dgboost/config.hpp> // make sure 'size_t' is placed into 'std'
#include <cstddef>
...
dgboost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
dgboost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
dgboost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
dgboost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
dgboost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
dgboost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::dgboost::mpl::if_c<p_type::value,
...
template< typename Pred >
typename assert_arg_type< dgboost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          dgboost::mpl::assertion_failed<false>( \
              dgboost::mpl::make_assert_arg< \
                  typename dgboost::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          dgboost::mpl::assertion_failed<false>( \
              dgboost::mpl::make_assert_arg< \
                  typename dgboost::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          dgboost::mpl::assertion_failed<false>( \
              dgboost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          dgboost::mpl::assertion<false>::failed( \
              dgboost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        dgboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (dgboost::mpl::failed ************ ( dgboost::mpl::assert_relation< \
                  dgboost::mpl::assert_::relations( sizeof( \
                      dgboost::mpl::assert_::arg rel dgboost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        dgboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              dgboost::mpl::assert_rel_arg( dgboost::mpl::assert_relation< \
                  dgboost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        dgboost::mpl::assertion_failed<(x rel y)>( dgboost::mpl::assert_rel_arg( \
              dgboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&dgboost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        dgboost::mpl::assertion_failed<(x rel y)>( (dgboost::mpl::failed ************ ( \
            dgboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&dgboost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : dgboost::mpl::assert_ \
{ \
    using dgboost::mpl::assert_::types; \
    static dgboost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        dgboost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        dgboost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
