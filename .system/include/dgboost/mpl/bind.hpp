...
#   include <dgboost/mpl/bind_fwd.hpp>
...
#   include <dgboost/mpl/limits/arity.hpp>
#   include <dgboost/mpl/aux_/na.hpp>
#   include <dgboost/mpl/aux_/arity_spec.hpp>
...
#include <dgboost/mpl/aux_/config/bind.hpp>
...
#   include <dgboost/mpl/aux_/preprocessor/params.hpp>
#   include <dgboost/mpl/aux_/preprocessor/default_params.hpp>
#   include <dgboost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <dgboost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <dgboost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <dgboost/mpl/aux_/preprocessor/repeat.hpp>
#   include <dgboost/mpl/aux_/preprocessor/enum.hpp>
#   include <dgboost/mpl/aux_/preprocessor/add.hpp>
#   include <dgboost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <dgboost/mpl/aux_/config/ctps.hpp>
#   include <dgboost/mpl/aux_/config/ttp.hpp>
...
template< typename T > struct is_bind_template
    : is_bind_template_impl< ::dgboost::detail::is_reference_impl<T>::value >
        ::template result_<T>
{
};
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <dgboost/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <dgboost/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#include <dgboost/mpl/aux_/count_args.hpp>
}
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <dgboost/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
