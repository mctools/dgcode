...
//   12 Nov 00  Merged <dgboost/stdint.h> (Jens Maurer)
//   23 Sep 00  Added INTXX_C macro support (John Maddock).
//   22 Sep 00  Better 64-bit support (John Maddock)
//   29 Jun 00  Reimplement to avoid including stdint.h within namespace dgboost
...
# include <dgboost/limits.hpp> // implementation artifact; not part of interface
...
#    endif
     ...
     typedef  ::dgboost::long_long_type            intmax_t;
     typedef  ::dgboost::ulong_long_type   uintmax_t;
     typedef  ::dgboost::long_long_type            int64_t;
     typedef  ::dgboost::long_long_type            int_least64_t;
     typedef  ::dgboost::long_long_type            int_fast64_t;
     typedef  ::dgboost::ulong_long_type   uint64_t;
     typedef  ::dgboost::ulong_long_type   uint_least64_t;
     typedef  ::dgboost::ulong_long_type   uint_fast64_t;
...
#   define INT8_C(value) static_cast<dgboost::int8_t>(value)
#   define UINT8_C(value) static_cast<dgboost::uint8_t>(value##u)
#  endif

//  16-bit types  -----------------------------------------------------------//

#  if (USHRT_MAX == 0xffff) && !defined(INT16_C)
#   define INT16_C(value) static_cast<dgboost::int16_t>(value)
#   define UINT16_C(value) static_cast<dgboost::uint16_t>(value##u)
#  endif
