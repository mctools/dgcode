...
#include <dgboost/range/rend.hpp>
#include <dgboost/range/rbegin.hpp>
#include <dgboost/range/iterator.hpp>
#include <dgboost/range/reverse_iterator.hpp>
...
#include <dgboost/foreach_fwd.hpp>

#ifdef BOOST_FOREACH_RUN_TIME_CONST_RVALUE_DETECTION
# include <new>
# include <dgboost/aligned_storage.hpp>
...
namespace foreach
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // dgboost::foreach::is_lightweight_proxy
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // dgboost::foreach::is_noncopyable
    ...
    struct is_noncopyable
      ...
      : dgboost::mpl::or_<
            dgboost::is_abstract<T>
          , dgboost::is_base_and_derived<dgboost::noncopyable, T>
        >
...
#else
# define BOOST_FOREACH_TAG_DEFAULT dgboost::foreach::tag
#endif
...
template<typename T>
inline dgboost::foreach::is_lightweight_proxy<T> *
boost_foreach_is_lightweight_proxy(T *&, BOOST_FOREACH_TAG_DEFAULT) { return 0; }

template<typename T>
inline dgboost::mpl::true_ *
boost_foreach_is_lightweight_proxy(std::pair<T, T> *&, dgboost::foreach::tag) { return 0; }

template<typename T>
inline dgboost::mpl::true_ *
boost_foreach_is_lightweight_proxy(dgboost::iterator_range<T> *&, dgboost::foreach::tag) { return 0; }

template<typename T>
inline dgboost::mpl::true_ *
boost_foreach_is_lightweight_proxy(dgboost::sub_range<T> *&, dgboost::foreach::tag) { return 0; }

template<typename T>
inline dgboost::mpl::true_ *
boost_foreach_is_lightweight_proxy(T **&, dgboost::foreach::tag) { return 0; }
...
//   at the global namespace for your type.
template<typename T>
inline dgboost::foreach::is_noncopyable<T> *
...
inline dgboost::mpl::and_<Bool1, Bool2> *and_(Bool1 *, Bool2 *) { return 0; }

template<typename Bool1, typename Bool2, typename Bool3>
inline dgboost::mpl::and_<Bool1, Bool2, Bool3> *and_(Bool1 *, Bool2 *, Bool3 *) { return 0; }

template<typename Bool1, typename Bool2>
inline dgboost::mpl::or_<Bool1, Bool2> *or_(Bool1 *, Bool2 *) { return 0; }

template<typename Bool1, typename Bool2, typename Bool3>
inline dgboost::mpl::or_<Bool1, Bool2, Bool3> *or_(Bool1 *, Bool2 *, Bool3 *) { return 0; }

template<typename Bool1>
inline dgboost::mpl::not_<Bool1> *not_(Bool1 *) { return 0; }

template<typename T>
inline dgboost::is_array<T> *is_array_(T const &) { return 0; }

template<typename T>
inline dgboost::is_const<T> *is_const_(T &) { return 0; }

#ifndef BOOST_FOREACH_NO_RVALUE_DETECTION
template<typename T>
inline dgboost::mpl::true_ *is_const_(T const &) { return 0; }
#endif

#ifdef BOOST_NO_CXX11_RVALUE_REFERENCES
template<typename T>
inline dgboost::mpl::false_ *is_rvalue_(T &, int) { return 0; }

template<typename T>
inline dgboost::mpl::true_ *is_rvalue_(T const &, ...) { return 0; }
#else
template<typename T>
inline dgboost::is_rvalue_reference<T &&> *is_rvalue_(T &&, int) { return 0; }
#endif
...
inline BOOST_DEDUCED_TYPENAME dgboost::mpl::if_<C, T const, T>::type &auto_any_cast(auto_any_t a)
{
    return static_cast<auto_any<T> const &>(a).item;
}

typedef dgboost::mpl::true_ const_;

///////////////////////////////////////////////////////////////////////////////
// type2type
//
template<typename T, typename C = dgboost::mpl::false_>
struct type2type
  : dgboost::mpl::if_<C, T const, T>
{
};
...
struct foreach_iterator
{
    ...
    //
    // To treat the container as an array, use dgboost::as_array() in <dgboost/range/as_array.hpp>,
    // as in BOOST_FOREACH( char ch, dgboost::as_array("hello") ) ...
    ...
    typedef BOOST_DEDUCED_TYPENAME dgboost::mpl::eval_if<
        C
...
//
template<typename T>
inline type2type<T> *encode_type(T &, dgboost::false_type*) { return 0; }

template<typename T>
inline type2type<T, const_> *encode_type(T const &, dgboost::true_type*) { return 0; }

template<typename T>
inline type2type<T> *encode_type(T &, dgboost::mpl::false_*) { return 0; }

template<typename T>
inline type2type<T, const_> *encode_type(T const &, dgboost::mpl::true_*) { return 0; }
...
# define BOOST_FOREACH_DEREFOF(T) dgboost::foreach_detail_::derefof(*T)
#else
...
# define BOOST_FOREACH_IS_RVALUE(COL)                                                           \
    dgboost::foreach_detail_::is_rvalue_((COL), 0)
...
struct rvalue_probe
{
    ...
    typedef BOOST_DEDUCED_TYPENAME dgboost::mpl::if_<
        dgboost::mpl::or_<dgboost::is_abstract<T>, dgboost::is_array<T> >, private_type_, T
    >::type value_type;
...
# define BOOST_FOREACH_IS_RVALUE(COL)                                                           \
    dgboost::foreach_detail_::and_(                                                               \
        dgboost::foreach_detail_::not_(dgboost::foreach_detail_::is_array_(COL))                    \
      , (true ? 0 : dgboost::foreach_detail_::is_rvalue_(                                         \
            (true ? dgboost::foreach_detail_::make_probe(COL) : (COL)), 0)))
...
struct rvalue_probe
{
    ...
    typedef BOOST_DEDUCED_TYPENAME dgboost::mpl::if_<
        dgboost::is_array<T>, private_type_, T
    >::type value_type;
    #else
    typedef BOOST_DEDUCED_TYPENAME dgboost::mpl::if_<
        dgboost::mpl::or_<dgboost::is_abstract<T>, dgboost::is_array<T> >, private_type_, T
...
inline BOOST_DEDUCED_TYPENAME dgboost::enable_if<dgboost::mpl::or_<LValue, IsProxy>, IsProxy>::type *
...
inline bool *
should_copy_impl(dgboost::mpl::false_ *, dgboost::mpl::false_ *, bool *is_rvalue)
{
    return is_rvalue;
}
...
//
template<typename T>
inline auto_any<T> contain(T const &t, dgboost::mpl::true_ *) // rvalue
{
    return auto_any<T>(t);
}

template<typename T>
inline auto_any<T *> contain(T &t, dgboost::mpl::false_ *) // lvalue
{
    // Cannot seem to get sunpro to handle addressof() with array types.
    #if BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0x570))
    return auto_any<T *>(&t);
    #else
    return auto_any<T *>(dgboost::addressof(t));
    #endif
}
...
begin(auto_any_t col, type2type<T, C> *, dgboost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        dgboost::begin(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>
begin(auto_any_t col, type2type<T, C> *, dgboost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        iterator(dgboost::begin(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, dgboost::mpl::false_>(col))))));
}
...
begin(auto_any_t col, type2type<T, const_> *, bool *)
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, const_>::type>(
        dgboost::begin(*auto_any_cast<simple_variant<T>, dgboost::mpl::false_>(col).get()));
}
#endif
...
template<typename T, typename C>
inline auto_any<T *>
begin(auto_any_t col, type2type<T *, C> *, dgboost::mpl::true_ *) // null-terminated C-style strings
{
    return auto_any<T *>(auto_any_cast<T *, dgboost::mpl::false_>(col));
}
#endif
...
template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>
end(auto_any_t col, type2type<T, C> *, dgboost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        dgboost::end(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>
end(auto_any_t col, type2type<T, C> *, dgboost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type>(
        iterator(dgboost::end(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, dgboost::mpl::false_>(col))))));
}
...
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_iterator<T, const_>::type>(
        dgboost::end(*auto_any_cast<simple_variant<T>, dgboost::mpl::false_>(col).get()));
}
#endif
...
template<typename T, typename C>
inline auto_any<int>
end(auto_any_t, type2type<T *, C> *, dgboost::mpl::true_ *) // null-terminated C-style strings
{
...
inline bool done(auto_any_t cur, auto_any_t end, type2type<T, C> *)
{
    ...
    return auto_any_cast<iter_t, dgboost::mpl::false_>(cur) == auto_any_cast<iter_t, dgboost::mpl::false_>(end);
}
...
{
    return ! *auto_any_cast<T *, dgboost::mpl::false_>(cur);
}
#endif
...
{
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iter_t;
    ++auto_any_cast<iter_t, dgboost::mpl::false_>(cur);
}
...
{
    typedef BOOST_DEDUCED_TYPENAME foreach_iterator<T, C>::type iter_t;
    return *auto_any_cast<iter_t, dgboost::mpl::false_>(cur);
}
...
rbegin(auto_any_t col, type2type<T, C> *, dgboost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        dgboost::rbegin(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>
rbegin(auto_any_t col, type2type<T, C> *, dgboost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        iterator(dgboost::rbegin(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, dgboost::mpl::false_>(col))))));
}
...
rbegin(auto_any_t col, type2type<T, const_> *, bool *)
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, const_>::type>(
        dgboost::rbegin(*auto_any_cast<simple_variant<T>, dgboost::mpl::false_>(col).get()));
}
#endif
...
rbegin(auto_any_t col, type2type<T *, C> *, dgboost::mpl::true_ *) // null-terminated C-style strings
{
    T *p = auto_any_cast<T *, dgboost::mpl::false_>(col);
    while(0 != *p)
        ++p;
...
template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>
rend(auto_any_t col, type2type<T, C> *, dgboost::mpl::true_ *) // rvalue
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        dgboost::rend(auto_any_cast<T, C>(col)));
}

template<typename T, typename C>
inline auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>
rend(auto_any_t col, type2type<T, C> *, dgboost::mpl::false_ *) // lvalue
{
    typedef BOOST_DEDUCED_TYPENAME type2type<T, C>::type type;
    typedef BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type iterator;
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, C>::type>(
        iterator(dgboost::rend(BOOST_FOREACH_DEREFOF((auto_any_cast<type *, dgboost::mpl::false_>(col))))));
}
...
{
    return auto_any<BOOST_DEDUCED_TYPENAME foreach_reverse_iterator<T, const_>::type>(
        dgboost::rend(*auto_any_cast<simple_variant<T>, dgboost::mpl::false_>(col).get()));
}
#endif
...
template<typename T, typename C>
inline auto_any<reverse_iterator<T *> >
rend(auto_any_t col, type2type<T *, C> *, dgboost::mpl::true_ *) // null-terminated C-style strings
{
    return auto_any<reverse_iterator<T *> >(
        reverse_iterator<T *>(auto_any_cast<T *, dgboost::mpl::false_>(col)));
}
#endif
...
#define BOOST_FOREACH_TYPEOF(COL)                                                               \
    (true ? BOOST_FOREACH_NULL : dgboost::foreach_detail_::encode_type(COL, dgboost::foreach_detail_::is_const_(COL)))

// returns true_* if the type is noncopyable
#define BOOST_FOREACH_IS_NONCOPYABLE(COL)                                                       \
    boost_foreach_is_noncopyable(                                                               \
        dgboost::foreach_detail_::to_ptr(COL)                                                     \
...
#define BOOST_FOREACH_IS_LIGHTWEIGHT_PROXY(COL)                                                 \
    dgboost::foreach_detail_::and_(                                                               \
        dgboost::foreach_detail_::not_(BOOST_FOREACH_IS_NONCOPYABLE(COL))                         \
      , boost_foreach_is_lightweight_proxy(                                                     \
            dgboost::foreach_detail_::to_ptr(COL)                                                 \
          , boost_foreach_argument_dependent_lookup_hack_value))
...
# define BOOST_FOREACH_SHOULD_COPY(COL)                                                         \
    (true ? BOOST_FOREACH_NULL : dgboost::foreach_detail_::or_(                                                    \
...
# define BOOST_FOREACH_EVALUATE(COL)                                                            \
    (true ? dgboost::foreach_detail_::make_probe((COL), BOOST_FOREACH_ID(_foreach_is_rvalue)) : (COL))
...
# define BOOST_FOREACH_SHOULD_COPY(COL)                                                         \
    (dgboost::foreach_detail_::should_copy_impl(                                                  \
        true ? BOOST_FOREACH_NULL : dgboost::foreach_detail_::or_(                                                 \
            dgboost::foreach_detail_::is_array_(COL)                                              \
          , BOOST_FOREACH_IS_NONCOPYABLE(COL)                                                   \
          , dgboost::foreach_detail_::not_(dgboost::foreach_detail_::is_const_(COL)))               \
...
#define BOOST_FOREACH(VAR, COL)                                                                                   \
    ...
    if (dgboost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_col) = BOOST_FOREACH_CONTAIN(COL)) {} else   \
    if (dgboost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_cur) = BOOST_FOREACH_BEGIN(COL)) {} else     \
    if (dgboost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_end) = BOOST_FOREACH_END(COL)) {} else       \
    for (bool BOOST_FOREACH_ID(_foreach_continue) = true;                                                         \
              BOOST_FOREACH_ID(_foreach_continue) && !BOOST_FOREACH_DONE(COL);                                    \
              BOOST_FOREACH_ID(_foreach_continue) ? BOOST_FOREACH_NEXT(COL) : (void)0)                            \
        if  (dgboost::foreach_detail_::set_false(BOOST_FOREACH_ID(_foreach_continue))) {} else                      \
...
#define BOOST_REVERSE_FOREACH(VAR, COL)                                                                           \
    BOOST_FOREACH_PREAMBLE()                                                                                      \
    if (dgboost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_col) = BOOST_FOREACH_CONTAIN(COL)) {} else   \
    if (dgboost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_cur) = BOOST_FOREACH_RBEGIN(COL)) {} else    \
    if (dgboost::foreach_detail_::auto_any_t BOOST_FOREACH_ID(_foreach_end) = BOOST_FOREACH_REND(COL)) {} else      \
    for (bool BOOST_FOREACH_ID(_foreach_continue) = true;                                                         \
