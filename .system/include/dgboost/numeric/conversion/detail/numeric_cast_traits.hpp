...
//
    ...
    #include <dgboost/numeric/conversion/detail/preprocessed/numeric_cast_traits_common.hpp>
	
	#if !defined(BOOST_NO_LONG_LONG)
        #include <dgboost/numeric/conversion/detail/preprocessed/numeric_cast_traits_long_long.hpp>
	#endif
    ...
    #include <dgboost/preprocessor/iteration/iterate.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace numeric {
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_A())), <dgboost/numeric/conversion/detail/numeric_cast_traits.hpp>))
    #include BOOST_PP_ITERATE()    

}}//namespace dgboost::numeric;
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(dgboost::long_long_type)(dgboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (dgboost::long_long_type)(dgboost::ulong_long_type)
    ...
    #define BOOST_PP_ITERATION_PARAMS_2 (3, (0, BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(BOOST_NUMERIC_CONVERSION_SEQ_B())), <dgboost/numeric/conversion/detail/numeric_cast_traits.hpp>))
    #include BOOST_PP_ITERATE()
