...
#include <dgboost/math/tools/is_standalone.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace math { namespace tools { namespace detail {
template <typename T>
struct type {};
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)              dgboost::math::tools::detail::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)         dgboost::math::tools::detail::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)       dgboost::math::tools::detail::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  dgboost::math::tools::detail::non_type<t, v>*
