...
#include <dgboost/cstdint.hpp> // for dgboost::uintmax_t
...
#include <dgboost/math/tools/user.hpp>
...
#  include "dgboost/non_type.hpp"

#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         dgboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    dgboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  dgboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  dgboost::non_type<t, v>*
...
#  define BOOST_MATH_NOEXCEPT(T) noexcept(dgboost::is_floating_point<T>::value)
#  define BOOST_MATH_IS_FLOAT(T) (dgboost::is_floating_point<T>::value)
#endif
#else
...
{
   static const bool value = dgboost::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
}} // namespace dgboost namespace math
...
//
   ...
   #include <dgboost/detail/fenv.hpp>
...
#    define BOOST_FPU_EXCEPTION_GUARD dgboost::math::detail::fpu_guard local_guard_object;
