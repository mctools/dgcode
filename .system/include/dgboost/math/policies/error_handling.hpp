...
#include <dgboost/config/no_tr1/cmath.hpp>
#include <stdexcept>
#include <dgboost/math/tools/config.hpp>
#include <dgboost/math/policies/policy.hpp>
#include <dgboost/math/tools/precision.hpp>
...
namespace dgboost {} namespace boost = dgboost; namespace dgboost{ namespace math{
...
{
   typedef typename dgboost::math::policies::precision<T, dgboost::math::policies::policy<> >::type prec_type;
   std::stringstream ss;
   if(prec_type::value)
   {
...
#ifndef BOOST_NO_RTTI
  replace_all_in_string(function, "%1%", dgboost::math::policies::detail::name_of<T>());
#else
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const ::dgboost::math::policies::domain_error< ::dgboost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::dgboost::math::policies::domain_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
...
inline T raise_domain_error(
           ...
           const char* ,
           const T& ,
           const ::dgboost::math::policies::domain_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
...
inline T raise_domain_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::domain_error< ::dgboost::math::policies::user_error>&)
{
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::pole_error< ::dgboost::math::policies::throw_on_error>&)
{
   return dgboost::math::policies::detail::raise_domain_error(function, message, val,  ::dgboost::math::policies::domain_error< ::dgboost::math::policies::throw_on_error>());
}
...
inline BOOST_MATH_CONSTEXPR T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::pole_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::dgboost::math::policies::detail::raise_domain_error(function, message, val,  ::dgboost::math::policies::domain_error< ::dgboost::math::policies::ignore_error>());
}
...
inline BOOST_MATH_CONSTEXPR T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::pole_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   return  ::dgboost::math::policies::detail::raise_domain_error(function, message, val,  ::dgboost::math::policies::domain_error< ::dgboost::math::policies::errno_on_error>());
}
...
inline T raise_pole_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::pole_error< ::dgboost::math::policies::user_error>&)
{
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::dgboost::math::policies::overflow_error< ::dgboost::math::policies::throw_on_error>&)
{
   raise_error<std::overflow_error, T>(function, message ? message : "numeric overflow");
   // We should never get here:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : dgboost::math::tools::max_value<T>();
}
...
inline BOOST_MATH_CONSTEXPR T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::dgboost::math::policies::overflow_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return std::numeric_limits<T>::has_infinity ? std::numeric_limits<T>::infinity() : dgboost::math::tools::max_value<T>();
...
inline T raise_overflow_error(
           const char* ,
           const char* ,
           const  ::dgboost::math::policies::overflow_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_overflow_error(
           const char* function,
           const char* message,
           const  ::dgboost::math::policies::overflow_error< ::dgboost::math::policies::user_error>&)
{
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::dgboost::math::policies::underflow_error< ::dgboost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_underflow_error(
           const char* ,
           const char* ,
           const  ::dgboost::math::policies::underflow_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return T(0);
...
inline T raise_underflow_error(
           const char* /* function */,
           const char* /* message */,
           const  ::dgboost::math::policies::underflow_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_underflow_error(
           const char* function,
           const char* message,
           const  ::dgboost::math::policies::underflow_error< ::dgboost::math::policies::user_error>&)
{
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& /* val */,
           const  ::dgboost::math::policies::denorm_error< ::dgboost::math::policies::throw_on_error>&)
{
...
inline BOOST_MATH_CONSTEXPR T raise_denorm_error(
           ...
           const char* ,
           const T&  val,
           const  ::dgboost::math::policies::denorm_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_denorm_error(
           ...
           const char* ,
           const T& val,
           const  ::dgboost::math::policies::denorm_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_denorm_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::denorm_error< ::dgboost::math::policies::user_error>&)
{
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::evaluation_error< ::dgboost::math::policies::throw_on_error>&)
{
   raise_error<dgboost::math::evaluation_error, T>(function, message, val);
   // we never get here:
   return T(0);
}
...
inline BOOST_MATH_CONSTEXPR T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::dgboost::math::policies::evaluation_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return val;
...
inline T raise_evaluation_error(
           ...
           const char* ,
           const T& val,
           const  ::dgboost::math::policies::evaluation_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_evaluation_error(
           ...
           const char* message,
           const T& val,
           const  ::dgboost::math::policies::evaluation_error< ::dgboost::math::policies::user_error>&)
{
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::dgboost::math::policies::rounding_error< ::dgboost::math::policies::throw_on_error>&)
{
   raise_error<dgboost::math::rounding_error, T>(function, message, val);
   // we never get here:
   return TargetType(0);
}
...
inline BOOST_MATH_CONSTEXPR TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::dgboost::math::policies::rounding_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType&,
           const  ::dgboost::math::policies::rounding_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   errno = ERANGE;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
           ...
           const  ::dgboost::math::policies::rounding_error< ::dgboost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
{
   ...
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
   return  val > 0 ? dgboost::math::tools::max_value<T>() : -dgboost::math::tools::max_value<T>();
}
...
inline TargetType raise_rounding_error(
           ...
           const T& val,
           const TargetType& t,
           const  ::dgboost::math::policies::rounding_error< ::dgboost::math::policies::user_error>&)
{
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::dgboost::math::policies::indeterminate_result_error< ::dgboost::math::policies::throw_on_error>&)
{
   raise_error<std::domain_error, T>(function, message, val);
   // we never get here:
   return std::numeric_limits<T>::quiet_NaN();
...
inline BOOST_MATH_CONSTEXPR T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::dgboost::math::policies::indeterminate_result_error< ::dgboost::math::policies::ignore_error>&) BOOST_MATH_NOEXCEPT(T)
{
   // This may or may not do the right thing, but the user asked for the error
   // to be ignored so here we go anyway:
   return result;
...
inline T raise_indeterminate_result_error(
           ...
           const T& ,
           const R& result,
           const ::dgboost::math::policies::indeterminate_result_error< ::dgboost::math::policies::errno_on_error>&)
{
   errno = EDOM;
   // This may or may not do the right thing, but the user asked for the error
   // to be silent so here we go anyway:
...
inline T raise_indeterminate_result_error(
           ...
           const T& val,
           const R& ,
           const ::dgboost::math::policies::indeterminate_result_error< ::dgboost::math::policies::user_error>&)
{
...
inline bool check_overflow(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      dgboost::math::policies::detail::raise_overflow_error<R>(function, 0, pol);
...
inline bool check_underflow(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(dgboost::math::policies::detail::raise_underflow_error<R>(function, 0, pol));
      return true;
   }
   return false;
}
...
inline bool check_denorm(T val, R* result, const char* function, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T) && (Policy::value != throw_on_error) && (Policy::value != user_error))
{
   ...
   {
      *result = static_cast<R>(dgboost::math::policies::detail::raise_denorm_error<R>(function, 0, static_cast<R>(val), pol));
      return true;
   }
   return false;
}
...
template <class T, class Policy>
inline void check_series_iterations(const char* function, dgboost::uintmax_t max_iter, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && is_noexcept_error_policy<Policy>::value)
{
...
template <class T, class Policy>
inline void check_root_iterations(const char* function, dgboost::uintmax_t max_iter, const Policy& pol) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(T) && is_noexcept_error_policy<Policy>::value)
{
