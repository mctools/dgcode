...
namespace detail {
  ...
  // signbit
    ...
    {
       return (dgboost::math::signbit)(static_cast<double>(x));
    }
    ...
    inline long double (changesign_impl)(long double x, generic_tag<true> const&)
    {
       ...
       pd[0] = dgboost::math::changesign(pd[0]);
       pd[1] = dgboost::math::changesign(pd[1]);
       return x;
    }
...
{
   return (z == 0) ? 0 : (dgboost::math::signbit)(z) ? -1 : 1;
}
   ...
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   ...
   return (dgboost::math::signbit)(static_cast<result_type>(x)) != (dgboost::math::signbit)(static_cast<result_type>(y)) 
      ? (dgboost::math::changesign)(static_cast<result_type>(x)) : static_cast<result_type>(x);
}
