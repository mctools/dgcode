...
#include <dgboost/math/tools/convert_from_string.hpp>
#ifdef BOOST_MSVC
#pragma warning(push)
  ...
  namespace constants
  {
   ...
   public:
      typedef typename mpl::if_<
         mpl::and_<dgboost::is_convertible<float, Real>, mpl::bool_< t1::value <= t2::value>, mpl::bool_<0 != t1::value> >,
         mpl::int_<construct_from_float>,
         typename mpl::if_<
            mpl::and_<dgboost::is_convertible<double, Real>, mpl::bool_< t1::value <= t3::value>, mpl::bool_<0 != t1::value> >,
            mpl::int_<construct_from_double>,
            typename mpl::if_<
               mpl::and_<dgboost::is_convertible<long double, Real>, mpl::bool_< t1::value <= t4::value>, mpl::bool_<0 != t1::value> >,
               mpl::int_<construct_from_long_double>,
#ifdef BOOST_MATH_USE_FLOAT128
               typename mpl::if_<
               mpl::and_<dgboost::is_convertible<BOOST_MATH_FLOAT128_TYPE, Real>, mpl::bool_< t1::value <= t5::value>, mpl::bool_<0 != t1::value> >,
...
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix) \
      dgboost::once_flag f = BOOST_ONCE_INIT;\
      dgboost::call_once(f, &BOOST_JOIN(BOOST_JOIN(string_, get_), name)<T>);
#else
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix)
#endif
   ...
   namespace detail{
      ...
      template <class Real, class Policy = dgboost::math::policies::policy<> >
...
#define BOOST_DEFINE_MATH_CONSTANT(name, x, y)\
   ...
   {\
      static const T result(dgboost::math::tools::convert_from_string<T>(y));\
      return result;\
   }\
   ...
   {\
      ...
      int current_digits = dgboost::math::tools::digits<T>();\
      if(digits != current_digits)\
      {\
         value = current_digits > max_string_digits ? compute<0>() : T(dgboost::math::tools::convert_from_string<T>(y));\
   ...
   { return name<T, dgboost::math::policies::policy<> >(); }\
   \
   \
...
//
#include <dgboost/math/constants/calculate_constants.hpp>
