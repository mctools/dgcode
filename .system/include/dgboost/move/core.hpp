...
// @endcond
   ...
   class BOOST_RV_ATTRIBUTE_MAY_ALIAS rv
      : public ::dgboost::move_detail::if_c
         < ::dgboost::move_detail::is_class<T>::value
         , T
         , ::dgboost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::dgboost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::dgboost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::dgboost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::dgboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::dgboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::dgboost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::dgboost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::dgboost::move_detail::enable_if_c
      <  ::dgboost::move_detail::is_lvalue_reference<Ret>::value ||
        !::dgboost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::dgboost::move_detail::enable_if_c
      < !::dgboost::move_detail::is_lvalue_reference<Ret>::value &&
         ::dgboost::has_move_emulation_enabled<T>::value
      , ::dgboost::rv<T>&>::type
         move_return(::dgboost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }

   template <class T>
   BOOST_MOVE_FORCEINLINE T& unrv(::dgboost::rv<T> &rv) BOOST_NOEXCEPT
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      dgboost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::dgboost::move((BASE_TYPE&)(ARG))
   //

   #define BOOST_MOVE_TO_LV(ARG) \
      ::dgboost::move_detail::unrv(ARG)
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::dgboost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::dgboost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::dgboost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::dgboost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< dgboost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::dgboost::move()` due to rvalue reference limitations.
   //!
