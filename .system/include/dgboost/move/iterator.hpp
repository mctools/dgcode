...
class move_iterator
{
   ...
   typedef typename dgboost::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::dgboost::move_detail::if_
      < ::dgboost::has_move_emulation_enabled<value_type>
      , ::dgboost::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename dgboost::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename dgboost::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
...
template <class I>
struct is_move_iterator< ::dgboost::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(dgboost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(dgboost::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::dgboost::move(x));
      ++pos_;
      return *this;
   }
