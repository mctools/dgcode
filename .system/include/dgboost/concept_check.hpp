...
//   01 April 2001: Modified to use new <dgboost/limits.hpp> header. (JMaddock)
//
...
# include <dgboost/concept/usage.hpp>
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct Integer< ::dgboost::long_long_type> {};
  template <> struct Integer< ::dgboost::ulong_long_type> {};
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct SignedInteger< ::dgboost::long_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct UnsignedInteger< ::dgboost::ulong_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
#define BOOST_DEFINE_BINARY_OPERATOR_CONSTRAINT(OP,NAME)    \
  ...
  BOOST_concept(UnaryFunction,(Func)(Return)(Arg))
  {
   ...
   private:
      ...
      // (warning: non-static reference "const double& dgboost::UnaryFunction<YourClassHere>::arg"
  ...
  BOOST_concept(BinaryFunction,(Func)(Return)(First)(Second))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a reference type.
      // (warning: non-static reference "const double& dgboost::BinaryFunction<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryFunction();
#endif
  ...
  BOOST_concept(UnaryPredicate,(Func)(Arg))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a reference type.
      // (warning: non-static reference "const double& dgboost::UnaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      UnaryPredicate();
#endif
  ...
  BOOST_concept(BinaryPredicate,(Func)(First)(Second))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a reference type.
      // (warning: non-static reference "const double& dgboost::BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryPredicate();
#endif
    Func f;
    ...
    : BinaryPredicate<Func, First, Second>
  {
   ...
   private:
    void const_constraints(const Func& fun) {
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a reference type.
      // (warning: non-static reference "const double& dgboost::Const_BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(SimpleAssociativeContainer)
      {
          typedef typename C::key_type key_type;
          typedef typename C::value_type value_type;
          BOOST_STATIC_ASSERT((dgboost::is_same<key_type,value_type>::value));
      }
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(PairAssociativeContainer)
      {
          ...
          BOOST_STATIC_ASSERT((dgboost::is_same<value_type,required_value_type>::value));
      }
  };
  ...
  BOOST_concept(Collection,(C))
  {
      ...
      {
        dgboost::function_requires<dgboost::InputIteratorConcept<iterator> >();
        dgboost::function_requires<dgboost::InputIteratorConcept<const_iterator> >();
        dgboost::function_requires<dgboost::CopyConstructibleConcept<value_type> >();
        const_constraints(c);
        i = c.begin();
        i = c.end();
        c.swap(c);
