...
# include <dgboost/python/converter/from_python.hpp>
# include <dgboost/python/detail/indirect_traits.hpp>
# include <dgboost/python/detail/type_traits.hpp>
# include <dgboost/python/converter/rvalue_from_python_data.hpp>
...
# include <dgboost/python/converter/registered_pointee.hpp>
# include <dgboost/python/detail/void_ptr.hpp>
# include <dgboost/python/back_reference.hpp>
# include <dgboost/python/detail/referent_storage.hpp>
# include <dgboost/python/converter/obj_mgr_arg_from_python.hpp>
...
{
    typedef typename dgboost::python::detail::add_lvalue_reference<
        T
...
struct back_reference_arg_from_python
    : dgboost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef dgboost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            dgboost::python::is_back_reference<T>
