...
# include <dgboost/python/ptr.hpp>
...
# include <dgboost/python/object/function_handle.hpp>

# include <dgboost/python/base_type_traits.hpp>

# include <dgboost/python/detail/indirect_traits.hpp>
# include <dgboost/python/detail/convertible.hpp>
  ...
  struct select_arg_to_python
  {
      ...
      typedef typename mpl::if_<
        ...
        , typename mpl::if_<
            ...
            , typename mpl::if_<
                mpl::or_<
                    dgboost::python::detail::is_function<T>
                  , indirect_traits::is_pointer_to_function<T>
                  , dgboost::python::detail::is_member_function_pointer<T>
                >
                ...
                , typename mpl::if_<
                    ...
                    , typename mpl::if_<
                          dgboost::python::detail::is_pointer<T>
