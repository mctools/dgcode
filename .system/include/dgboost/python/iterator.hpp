...
# include <dgboost/python/detail/target.hpp>
# include <dgboost/python/detail/type_traits.hpp>
# include <dgboost/python/object/iterator.hpp>
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, dgboost::type<Target>* = 0)
{
