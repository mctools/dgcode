...
# include <dgboost/python/return_internal_reference.hpp>
...
namespace detail
{
  ...
  // dgboost::python::make_getter are used to dispatch behavior.  The
  ...
  // dgboost::python::make_setter are used to dispatch behavior.  The
