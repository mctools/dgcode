...
template <class T>
inline typeinfo msvc_typeid(dgboost::type<T>*)
{
    return detail::typeid_ref(
        (dgboost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(dgboost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((dgboost::type<char const[3]>*)0)
        , msvc_typeid((dgboost::type<char[3]>*)0);
}
#  endif
