...
# else
#  define BOOST_PYTHON_BEGIN_CONVERSION_NAMESPACE namespace dgboost {} namespace boost = dgboost; namespace dgboost { namespace python {
#  define BOOST_PYTHON_END_CONVERSION_NAMESPACE }} // namespace dgboost::python
#  define BOOST_PYTHON_CONVERSION dgboost::python
...
//
#include <dgboost/config/auto_link.hpp>
