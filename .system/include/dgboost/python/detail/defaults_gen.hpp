...
#include <dgboost/preprocessor/tuple.hpp>
...
#define BOOST_PYTHON_TYPEDEF_GEN(z, index, data)                                \
    typedef typename ::dgboost::mpl::next<BOOST_PP_CAT(iter, index)>::type        \
        BOOST_PP_CAT(iter, BOOST_PP_INC(index));                                \
    typedef typename ::dgboost::mpl::deref<BOOST_PP_CAT(iter, index)>::type       \
...
#define BOOST_PYTHON_GEN_FUNCTION(fname, fstubs_name, n_args, n_dflts, ret)     \
    ...
    {                                                                           \
        ...
        struct gen                                                              \
        {                                                                       \
            typedef typename ::dgboost::mpl::begin<SigT>::type rt_iter;           \
            typedef typename ::dgboost::mpl::deref<rt_iter>::type RT;             \
            typedef typename ::dgboost::mpl::next<rt_iter>::type iter0;           \
                                                                                \
            BOOST_PP_REPEAT_2ND(                                                \
                n_args,                                                         \
...
#define BOOST_PYTHON_GEN_MEM_FUNCTION(fname, fstubs_name, n_args, n_dflts, ret) \
    ...
    {                                                                           \
        ...
        {                                                                       \
            ...
            typedef typename ::dgboost::mpl::deref<rt_iter>::type RT;             \
                                                                                \
            typedef typename ::dgboost::mpl::next<rt_iter>::type class_iter;      \
            typedef typename ::dgboost::mpl::deref<class_iter>::type ClassT;      \
            typedef typename ::dgboost::mpl::next<class_iter>::type iter0;        \
                                                                                \
            BOOST_PP_REPEAT_2ND(                                                \
                n_args,                                                         \
                BOOST_PYTHON_TYPEDEF_GEN,                                       \
...
#define BOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args, n_dflts)                    \
    fstubs_name(char const* doc = 0)                                                        \
        : ::dgboost::python::detail::overloads_common<fstubs_name>(doc) {}                    \
    template <std::size_t N>                                                                \
    fstubs_name(char const* doc, ::dgboost::python::detail::keywords<N> const& keywords)      \
        : ::dgboost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        typedef typename ::dgboost::python::detail::                                          \
            error::more_keywords_than_function_arguments<                                   \
                N,n_args>::too_many_keywords assertion BOOST_ATTRIBUTE_UNUSED;              \
    }                                                                                       \
    template <std::size_t N>                                                                \
    fstubs_name(::dgboost::python::detail::keywords<N> const& keywords, char const* doc = 0)  \
        : ::dgboost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        typedef typename ::dgboost::python::detail::                                          \
...
#  define BOOST_PYTHON_GEN_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)   \
    struct fstubs_name                                                          \
        : public ::dgboost::python::detail::overloads_common<fstubs_name>         \
    {                                                                           \
...
//          : public dgboost::python::detail::overloads_common<foo_overloads>
//      {
...
//             : dgboost::python::detail::overloads_common<foo_overloads>(doc) {}
//      };
//
