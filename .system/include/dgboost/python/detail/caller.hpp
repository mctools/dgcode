...
#  include <dgboost/detail/indirect_traits.hpp>

#  include <dgboost/python/detail/invoke.hpp>
...
#  include <dgboost/python/arg_from_python.hpp>
#  include <dgboost/python/converter/context_result_converter.hpp>
...
#  include <dgboost/compressed_pair.hpp>
...
template<class Policies, class Sig> const signature_element* get_ret()
{
    ...
    static const signature_element ret = {
        ...
        , dgboost::detail::indirect_traits::is_reference_to_non_const<rtype>::value 
    };
...
#  define BOOST_PP_ITERATION_PARAMS_1                                            \
        (3, (0, BOOST_PYTHON_MAX_ARITY + 1, <dgboost/python/detail/caller.hpp>))
