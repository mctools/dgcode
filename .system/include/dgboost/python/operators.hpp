...
# include <dgboost/python/other.hpp>
# include <dgboost/lexical_cast.hpp>
...
using dgboost::python::self_ns::abs;
using dgboost::python::self_ns::int_;
using dgboost::python::self_ns::long_;
using dgboost::python::self_ns::float_;
using dgboost::python::self_ns::complex_;
using dgboost::python::self_ns::str;
using dgboost::python::self_ns::repr;
using dgboost::python::self_ns::pow;
# endif
