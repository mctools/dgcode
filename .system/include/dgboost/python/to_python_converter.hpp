...
# include <dgboost/python/converter/as_to_python_function.hpp>
...
namespace detail
{
    ...
    template<class T>
    struct test_get_pytype : dgboost::mpl::bool_<test_get_pytype_base<T>::value> 
    {
    };
...
{
#ifndef BOOST_PYTHON_NO_PY_SIGNATURES
    typedef dgboost::mpl::bool_<has_get_pytype> HasGetPytype;

    static PyTypeObject const* get_pytype_1(dgboost::mpl::true_ *)
    {
        return Conversion::get_pytype();
    }

    static PyTypeObject const* get_pytype_1(dgboost::mpl::false_ *)
    {
        return 0;
    }
