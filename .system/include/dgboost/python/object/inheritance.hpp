...
struct dynamic_id_generator
  : mpl::if_<
        dgboost::python::detail::is_polymorphic<T>
        , dgboost::python::objects::polymorphic_id_generator<T>
        , dgboost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
struct cast_generator
  : mpl::if_<
        dgboost::python::detail::is_base_and_derived<Target,Source>
...
inline void register_conversion(
    bool is_downcast = ::dgboost::is_base_and_derived<Source,Target>::value
