...
#include <dgboost/python/converter/shared_ptr_from_python.hpp>
#include <dgboost/python/object/inheritance.hpp>
#include <dgboost/python/object/class_wrapper.hpp>
#include <dgboost/python/object/make_instance.hpp>
#include <dgboost/python/object/value_holder.hpp>
...
#include <dgboost/python/has_back_reference.hpp>
#include <dgboost/python/bases.hpp>
...
#include <dgboost/mpl/for_each.hpp>
#include <dgboost/mpl/placeholders.hpp>
#include <dgboost/mpl/single_view.hpp>
...
struct register_base_of
{
    ...
    {
        BOOST_MPL_ASSERT_NOT((dgboost::python::detail::is_same<Base,Derived>));
        ...
        this->register_downcast((Base*)0, dgboost::python::detail::is_polymorphic<Base>());
    }

 private:
    static inline void register_downcast(void*, dgboost::python::detail::false_) {}
    
    template <class Base>
    static inline void register_downcast(Base*, dgboost::python::detail::true_)
    {
...
inline void register_shared_ptr_from_python_and_casts(T*, Bases)
{
  ...
  python::detail::force_instantiate(converter::shared_ptr_from_python<T, dgboost::shared_ptr>());
  ...
  mpl::for_each(register_base_of<T>(), (Bases*)0, (dgboost::python::detail::add_pointer<mpl::_>*)0);
}
...
struct select_held_type
  : mpl::if_<
        mpl::or_<
          ...
          , dgboost::python::detail::is_same<T,noncopyable>
        >
      , Prev
      , T
    >
...
struct class_metadata
{
    ...
    typedef mpl::or_<
        dgboost::python::detail::is_same<X1,noncopyable>
      , dgboost::python::detail::is_same<X2,noncopyable>
      , dgboost::python::detail::is_same<X3,noncopyable>
    > is_noncopyable;
    ...
    typedef typename mpl::if_<
        dgboost::python::detail::is_same<held_type_arg,python::detail::not_specified>, T, held_type_arg
    >::type held_type;

    // Determine if the object will be held by value
    typedef mpl::bool_<dgboost::python::detail::is_convertible<held_type*,T*>::value> use_value_holder;
    ...
    typedef mpl::bool_<
        mpl::or_<
          ...
          , dgboost::python::detail::is_same<held_type_arg,T>
 ...
 private:
    ...
    {
        typedef typename mpl::not_<dgboost::python::detail::is_same<T2,wrapped> >::type use_callback;
