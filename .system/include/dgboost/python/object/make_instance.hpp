...
# include <dgboost/python/detail/decref_guard.hpp>
...
struct make_instance_impl
{
    ...
    {
        BOOST_MPL_ASSERT((mpl::or_<dgboost::python::detail::is_class<T>,
                dgboost::python::detail::is_union<T> >));
    ...
    : make_instance_impl<T, Holder, make_instance<T,Holder> >
{
    ...
    static inline Holder* construct(void* storage, PyObject* instance, reference_wrapper<T const> x)
    {
        ...
        void* aligned_storage = ::dgboost::alignment::align(dgboost::python::detail::alignment_of<Holder>::value,
