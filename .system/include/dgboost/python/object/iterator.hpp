...
# include <dgboost/python/class.hpp>
# include <dgboost/python/return_value_policy.hpp>
# include <dgboost/python/return_by_value.hpp>
...
)
{
    ...
    typedef typename dgboost::python::detail::add_const<iterator>::type iterator_const;
    typedef typename dgboost::python::detail::add_lvalue_reference<iterator_const>::type iterator_cref;
