...
#  include <dgboost/python/object/value_holder_fwd.hpp>

#  include <dgboost/python/instance_holder.hpp>
#  include <dgboost/python/type_id.hpp>
#  include <dgboost/python/wrapper.hpp>
...
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <dgboost/python/object/value_holder.hpp>, 1))
...
struct value_holder_back_reference : instance_holder
{
    ...
    // Forward construction to the held object
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <dgboost/python/object/value_holder.hpp>, 2))
#  include BOOST_PP_ITERATE()
...
{
    if (void* wrapped = holds_wrapped(dst_t, dgboost::addressof(m_held), dgboost::addressof(m_held)))
        return wrapped;
    
    type_info src_t = python::type_id<Value>();
    return src_t == dst_t ? dgboost::addressof(m_held)
        : find_static_type(dgboost::addressof(m_held), src_t, dst_t);
}
...
# endif
    ...
    {
        python::detail::initialize_wrapper(self, dgboost::addressof(this->m_held));
    }
