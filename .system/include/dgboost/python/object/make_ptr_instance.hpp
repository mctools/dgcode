 ...
 private:
    ...
    static inline PyTypeObject* get_class_object_impl(U const volatile* p)
    {
        ...
        PyTypeObject* derived = get_derived_class_object(
            BOOST_DEDUCED_TYPENAME dgboost::python::detail::is_polymorphic<U>::type(), p);
    ...
    template <class U>
    static inline PyTypeObject* get_derived_class_object(dgboost::python::detail::true_, U const volatile* x)
    {
    ...
    template <class U>
    static inline PyTypeObject* get_derived_class_object(dgboost::python::detail::false_, U*)
    {
        return 0;
    }
};
