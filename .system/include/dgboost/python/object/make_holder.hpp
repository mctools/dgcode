...
#  include <dgboost/python/detail/python_type.hpp>
#endif
...
// specializations...
#  define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PYTHON_MAX_ARITY, <dgboost/python/object/make_holder.hpp>))
...
# endif 
        ...
        static void execute(
#if !defined( BOOST_PYTHON_NO_PY_SIGNATURES) && defined( BOOST_PYTHON_PY_SIGNATURES_PROPER_INIT_SELF_TYPE)
            dgboost::python::detail::python_class<BOOST_DEDUCED_TYPENAME Holder::value_type> *p
#else
            PyObject *p
#endif
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS_Z(1, N, t, a))
        {
            ...
            void* memory = Holder::allocate(p, offsetof(instance_t, storage), sizeof(Holder),
                                            dgboost::python::detail::alignment_of<Holder>::value);
            try {
                (new (memory) Holder(
