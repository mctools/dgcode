...
# include <dgboost/python/class_fwd.hpp>
# include <dgboost/python/object/class.hpp>

# include <dgboost/python/object.hpp>
# include <dgboost/python/type_id.hpp>
# include <dgboost/python/data_members.hpp>
# include <dgboost/python/make_function.hpp>
# include <dgboost/python/signature.hpp>
# include <dgboost/python/init.hpp>
# include <dgboost/python/args_fwd.hpp>

# include <dgboost/python/object/class_metadata.hpp>
# include <dgboost/python/object/pickle_support.hpp>
# include <dgboost/python/object/add_to_namespace.hpp>

# include <dgboost/python/detail/overloads_fwd.hpp>
# include <dgboost/python/detail/operator_id.hpp>
# include <dgboost/python/detail/def_helper.hpp>
# include <dgboost/python/detail/force_instantiate.hpp>
# include <dgboost/python/detail/type_traits.hpp>
# include <dgboost/python/detail/unwrap_type_id.hpp>
# include <dgboost/python/detail/unwrap_wrapper.hpp>
