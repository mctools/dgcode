...
#include <dgboost/archive/polymorphic_oarchive.hpp>
...
private:
    ...
    virtual void save(const dgboost::long_long_type t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const dgboost::ulong_long_type t){
        ArchiveImplementation::save(t);
    }
    #elif defined(BOOST_HAS_MS_INT64)
    virtual void save(const dgboost::int64_t t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const dgboost::uint64_t t){
        ArchiveImplementation::save(t);
    }
    #endif
