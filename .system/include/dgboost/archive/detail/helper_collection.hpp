...
#include <dgboost/smart_ptr/make_shared.hpp>
...
class helper_collection
{
    ...
    typedef std::pair<
        const void *,
        dgboost::shared_ptr<void>
    > helper_value_type;
    template<class T>
    dgboost::shared_ptr<void> make_helper_ptr(){
        // use dgboost::shared_ptr rather than std::shared_ptr to maintain
        // c++03 compatibility
        return dgboost::make_shared<T>();
    }
