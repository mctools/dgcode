...
#include <dgboost/serialization/tracking_enum.hpp>
#include <dgboost/archive/basic_archive.hpp>
#include <dgboost/archive/detail/decl.hpp>
#include <dgboost/archive/detail/helper_collection.hpp>
...
class BOOST_SYMBOL_VISIBLE basic_iarchive :
    ...
    public dgboost::archive::detail::helper_collection
{
    friend class basic_iarchive_impl;
    // hide implementation of this class to minimize header conclusion
    dgboost::scoped_ptr<basic_iarchive_impl> pimpl;
...
protected:
    ...
    dgboost::archive::detail::helper_collection &
