...
class escape : 
    public dgboost::iterator_adaptor<
        Derived, 
        Base, 
        typename dgboost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        typename dgboost::iterator_value<Base>::type
    >
{
    typedef typename dgboost::iterator_value<Base>::type base_value_type;
    typedef typename dgboost::iterator_reference<Base>::type reference_type;
