...
#include <dgboost/spirit/include/classic_rule.hpp>
#include <dgboost/spirit/include/classic_chset.hpp>
...
private:
    ...
    typedef typename dgboost::spirit::classic::chset<CharType> chset_t;
    typedef typename dgboost::spirit::classic::chlit<CharType> chlit_t;
    typedef typename dgboost::spirit::classic::scanner<
        typename  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef typename dgboost::spirit::classic::rule<scanner_t> rule_t;
