...
#include <dgboost/archive/basic_text_oprimitive.hpp>

#include <dgboost/archive/iterators/base64_from_binary.hpp>
#include <dgboost/archive/iterators/insert_linebreaks.hpp>
#include <dgboost/archive/iterators/transform_width.hpp>
#include <dgboost/archive/iterators/ostream_iterator.hpp>
...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        dgboost::archive::iterators::insert_linebreaks<
            dgboost::archive::iterators::base64_from_binary<
                dgboost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    dgboost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
