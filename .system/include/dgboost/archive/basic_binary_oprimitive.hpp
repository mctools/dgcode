...
public:
    ...
    void save_array(dgboost::serialization::array_wrapper<ValueType> const& a, unsigned int)
    {
...
basic_binary_oprimitive<Archive, Elem, Tr>::save_binary(
    ...
    // BOOST_ASSERT(count <= std::size_t(dgboost::integer_traits<std::streamsize>::const_max));
