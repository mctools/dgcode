...
#include <dgboost/archive/detail/iserializer.hpp>
#include <dgboost/archive/detail/interface_iarchive.hpp>
#include <dgboost/serialization/nvp.hpp>
#include <dgboost/archive/detail/register_archive.hpp>

#include <dgboost/archive/detail/decl.hpp>
...
public:
    ...
    virtual void load(dgboost::long_long_type & t) = 0;
    virtual void load(dgboost::ulong_long_type & t) = 0;
    ...
    template<class T>
    void load_override(
        const dgboost::serialization::nvp< T > & t
    ){
        load_start(t.name());
...
public:
    ...
    virtual const detail::basic_pointer_iserializer * load_pointer(
        ...
        const detail::basic_pointer_iserializer * (*finder)(
            const dgboost::serialization::extended_type_info & type
        )
    ) = 0;
};
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::polymorphic_iarchive)
