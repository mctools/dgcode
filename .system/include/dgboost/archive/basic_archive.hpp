...
#include <dgboost/cstdint.hpp> // size_t
...
public:
    ...
    explicit library_version_type(const unsigned int & t_) : t(t_){
        BOOST_ASSERT(t_ <= dgboost::integer_traits<base_type>::const_max);
    }
...
#define NULL_POINTER_TAG dgboost::archive::class_id_type(-1)
...
#include <dgboost/archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas
...
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::library_version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::class_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::class_id_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::class_id_optional_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::class_name_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::object_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::object_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(dgboost::archive::tracking_type, primitive_type)
...
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::library_version_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::version_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::class_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::class_id_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::class_id_optional_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::class_name_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::object_id_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::object_reference_type)
BOOST_IS_BITWISE_SERIALIZABLE(dgboost::archive::tracking_type)
