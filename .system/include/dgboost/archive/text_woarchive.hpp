...
#include <dgboost/archive/basic_text_oarchive.hpp>
...
protected:
    ...
    void save(const dgboost::serialization::item_version_type & t){
        save(static_cast<unsigned int>(t));
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::text_woarchive)
