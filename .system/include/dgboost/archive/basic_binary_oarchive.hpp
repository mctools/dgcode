...
#include <dgboost/archive/detail/common_oarchive.hpp>
...
protected:
    ...
    #if 0
    void save_override(const dgboost::archive::version_type & t){
        ...
        if(dgboost::archive::library_version_type(6) < lvt){
            const dgboost::uint_least16_t x = t;
            * this->This() << x;
        }
        else{
    ...
    void save_override(const dgboost::serialization::item_version_type & t){
        library_version_type lvt = this->get_library_version();
        if(dgboost::archive::library_version_type(7) < lvt){
            this->detail_common_oarchive::save_override(t);
        }
    ...
    void save_override(class_id_type & t){
        ...
        if(dgboost::archive::library_version_type(6) < lvt){
            const dgboost::int_least16_t x = t;
            * this->This() << x;
        }
        else{
            const int x = t;
    ...
    void save_override(const serialization::collection_size_type & t){
        if (get_library_version() < dgboost::archive::library_version_type(6)){
            unsigned int x=0;
            * this->This() >> x;
