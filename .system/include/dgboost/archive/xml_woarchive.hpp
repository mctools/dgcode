...
#include <dgboost/archive/basic_xml_oarchive.hpp>
...
protected:
    ...
    void 
    save(const dgboost::serialization::item_version_type & t){
        save(static_cast<unsigned int>(t));
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::xml_woarchive)
