...
#include <dgboost/archive/detail/oserializer.hpp>
#include <dgboost/archive/detail/interface_oarchive.hpp>
...
public:
    ...
    virtual void save(const dgboost::long_long_type t) = 0;
    virtual void save(const dgboost::ulong_long_type t) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::polymorphic_oarchive)
