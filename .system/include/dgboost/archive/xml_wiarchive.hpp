...
#include <dgboost/smart_ptr/scoped_ptr.hpp>
#include <dgboost/archive/detail/auto_link_warchive.hpp>
#include <dgboost/archive/basic_text_iprimitive.hpp>
#include <dgboost/archive/basic_xml_iarchive.hpp>
...
protected:
    ...
    dgboost::scoped_ptr<xml_wgrammar> gimpl;
    std::wistream & get_is(){
        return is;
    }
    template<class T>
    ...
    void 
    load(dgboost::serialization::item_version_type & t){
        unsigned int v;
        load(v);
        t = dgboost::serialization::item_version_type(v);
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::xml_wiarchive)
