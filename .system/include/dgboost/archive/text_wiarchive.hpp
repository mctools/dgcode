...
#include <dgboost/archive/basic_text_iarchive.hpp>
...
protected:
    ...
    void load(dgboost::serialization::item_version_type & t){
        unsigned int v;
        load(v);
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::text_wiarchive)
