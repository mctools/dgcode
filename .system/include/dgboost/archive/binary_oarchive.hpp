...
#include <dgboost/archive/binary_oarchive_impl.hpp>
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(dgboost::archive::binary_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(dgboost::archive::binary_oarchive)
