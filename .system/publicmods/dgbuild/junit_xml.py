...
## TK:copied from PKG-INFO ###
## TK:copied from PKG-INFO ### Metadata-Version: 1.1
## TK:copied from PKG-INFO ### Name: junit-xml
## TK:copied from PKG-INFO ### Version: 1.8
## TK:copied from PKG-INFO ### Summary: Creates JUnit XML test result documents that can be read by tools such as Jenkins
## TK:copied from PKG-INFO ### Home-page: https://github.com/kyrus/python-junit-xml
## TK:copied from PKG-INFO ### Author: Brian Beyer
## TK:copied from PKG-INFO ### Author-email: brian@kyr.us
## TK:copied from PKG-INFO ### License: MIT
## TK:copied from PKG-INFO ### Description: python-junit-xml
