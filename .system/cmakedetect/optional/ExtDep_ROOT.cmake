...
if (root_config_file)
  message("-- Base ROOT setup on ${root_config_file}")
  ...
  if (NOT tmp MATCHES "-std=c\\+\\+1z" AND NOT tmp MATCHES "-std=c\\+\\+17" AND NOT tmp MATCHES "-std=c\\+\\+2a" AND NOT tmp MATCHES "-std=c\\+\\+20")
    message("-- Warning: The ROOT installation was not built with C++17 support and can not be used.")
...
if (root_config_file)
  ...
  if ( NOT "x${tmp}" STREQUAL "xyes" )
    message("-- Warning: ROOT does not have GDML enabled.")
    set(HAS_ROOT_GDML 0)
  else()
  ...
  string(STRIP "${tmp}" tmp)
  if ( NOT "x${tmp}" STREQUAL "xyes" )
    message("-- Warning: ROOT does not have Python enabled (NOTE: This now requires root 6.22 or later!).")
    ...
    if (NOT "x${tmp_ec}" STREQUAL "x0")
      message("-- Warning: ROOT has Python enabled but 'import ROOT' fails (likely it was compiled against a wrong Python installation or against Python2 instead of Python3).")
      set(HAS_ROOT_PYTHON 0)
    endif()
  endif()
  ...
  if ( NOT "x${tmp}" STREQUAL "xyes" )
    message("-- Warning: ROOT does not have Geom enabled.")
    set(HAS_ROOT_GEOM 0)
  else()
    set(HAS_ROOT_GEOM 1)
