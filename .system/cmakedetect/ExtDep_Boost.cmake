function( detect_system_boostpython resvar_found resvar_cflags_list resvar_linkflags_list resvar_boostincdir )
  ...
  if ( DEFINED ENV{CONDA_PREFIX} AND EXISTS "$ENV{CONDA_PREFIX}/include/boost/python.hpp" )
    file( GLOB boostcfglist "$ENV{CONDA_PREFIX}/lib/cmake/Boost-*/BoostConfig.cmake" )
    list( LENGTH boostcfglist nboostcfg )
    if ( nboostcfg EQUAL 1 )
      list( POP_FRONT boostcfglist Boost_DIR )
      cmake_path( GET Boost_DIR PARENT_PATH Boost_DIR )
      cmake_path( ABSOLUTE_PATH Boost_DIR NORMALIZE )
      set( Boost_USE_STATIC_RUNTIME OFF )
      set( findpkgargs Boost 1.78 NO_MODULE NO_DEFAULT_PATH COMPONENTS python )
      find_package( ${findpkgargs} )
      if ( Boost_FOUND )
        extract_extdep_flags( CXX "${findpkgargs}" "Boost::python"
